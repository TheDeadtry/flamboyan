...
<div class="panel panel-flat">
     ...
     <form class="form-horizontal" method="post" action="<?php echo site_url('markinformal/setpilihnya'); ?>">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="btn-group btn-group-animated">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo site_url('markinformal/tampidatagroup'); ?>"><i class="icon-spinner9"></i> 還沒入境 – BELUM KE TAIWAN</a></li>
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">PROGRESS MARKETING INFORMAL - 看護工-進度表.<br>已經入境 – SUDAH KE TAIWAN </h5>
                        <div class="heading-elements">
                            <ul class="icons-list">
                                <li><a data-action="collapse"></a></li>
                                <li><a data-action="reload"></a></li>

    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="btn-group btn-group-animated">
                                        <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">還沒入境 – BELUM KE TAIWAN <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li class="active"><a><i class="icon-spinner9"></i> 還沒入境 – BELUM KE TAIWAN</a></li>
                                            <li><a href="<?php echo site_url('markinformal/tampidatagroupnya'); ?>"><i class="icon-person"></i>  已經入境 – SUDAH KE TAIWAN</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">PROGRESS MARKETING INFORMAL - 看護工-進度表.  <br>還沒入境 – BELUM KE TAIWAN </h5>
                        <div class="heading-elements">
                            <ul class="icons-list">
                                <li><a data-action="collapse"></a></li>
                                <li><a data-action="reload"></a></li>

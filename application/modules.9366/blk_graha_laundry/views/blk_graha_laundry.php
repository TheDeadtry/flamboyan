            ...
            <div class="col-lg-9">
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo site_url('blk_graha_laundry/setdata/'.$idbio) ?>" method="POST">
                            <?php 
                        ...
                        <table class="table table-lg datatable-basic table-bordered table-striped">
                            ...
                            <tbody> 
                                ...
                                <div class="modal fade" id="tambahm" tabindex="-2" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form class="form-horizontal" method="post" action="<?php echo site_url('blk_graha_laundry/tambah_nilai/'.$idbio); ?>">
                                                ...
                                                <div class="modal-body">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select name="materi" class="form-control">
                                                                        ...
                                                                        ?>
                                                                            <option value="<?php echo $materi->id_graha_laundry ?>"><?php echo $materi->kode_materi.' : '.$materi->nama_materi ?></option>
                                                                        <?php
                                                                            }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="control-label col-sm-3">Nilai Teori</label>
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icon-pencil5"></i></span>
                                                                    <select name="nilai_tulis" class="form-control">
                                                                        <option class="tatagraha_penilai" id="namapenilai" value="none">Pilih Nilai Teori</option>
                                                                        <div class="list-group-divider"></div>
                                                                        <?php 
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="control-label col-sm-3">Nilai Praktek</label>
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icon-pencil7"></i></span>
                                                                    <select name="nilai_praktik" class="form-control" >
                                                                        <option class="tatagraha_penilai" id="namapenilai" value="none">Pilih Nilai Praktek</option>
                                                                        <div class="list-group-divider"></div>
                                                                        <?php 
                                 ...
                                 <?php 
                                    ...
                                    //foreach ($tampil_data_graha_laundry as $hasil) {
                                        $count  = $this->M_blk_graha_laundry->tampil_data_count($group->tgl,$idbio);
                                        //for($q=1;$q<=$count->total;$q++) {
                                            $h  = $this->M_blk_graha_laundry->tampil_data_graha_laundry($group->tgl,$idbio);
                                            foreach ($h as $hasil) {
                                         $no++;
                                        $id                 = $hasil->idpgl;
                                        ...
                                        $nilai_tulis        = $this->M_blk_graha_laundry->get_nilai($hasil->nt);
                                        $nilai_praktek      = $this->M_blk_graha_laundry->get_nilai($hasil->np);
                                        $row[$no]           = $count->total;
                                        
                                        $count_penilai = $this->M_blk_graha_laundry->tampil_data_count2($group->tgl,$idbio,$hasil->id_instruktur);

                                        //$tampil_data_laundry   = $this->M_blk_graha_laundry->tampil_data_laundry($group->tgl,$idbio);
                                        //$data['tampil_data_count']      = $this->M_blk_graha_laundry->tampil_data_count($idbio);
                                        if ($row[$no] > 1) {
                                            if ($tgl[$no-1] == $tgl[$no]) {
                                                $c++;
                                            } else {
                                ...
                                <div class="modal fade" id="ubah<?php echo $no ?>" tabindex="-2" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form class="form-horizontal" method="post" action="<?php echo site_url('blk_graha_laundry/ubah_nilai/'.$idbio); ?>">
                                                <div class="modal-header bg-primary">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icon-user"></i></span>
                                                                    <select name="materi" class="form-control">
                                                                        <option class="tatagraha_penilai" id="namapenilai" value="<?php echo $hasil->id_graha_laundry ?>"><?php echo $materi ?></option>
                                                                        <div class="list-group-divider"></div>
                                                                        <?php 
                                                                            foreach ($tampil_data_blk_materi as $materi) {
                                                                        ?>
                                ...
                                <div id="hapus<?php echo $no; ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo site_url('blk_graha_laundry/hapus_nilai/'.$idbio); ?>" class="form-horizontal" method="post">                                       
                                                <div class="modal-body">
                                    ...
                                    <table class="table table-lg datatable-basic table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="2" class="text-center">TEORI</th>
                                                <th colspan="2" class="text-center">PRAKTEK</th>
                                            </tr>
                                            <tr>
                                        ...
                                        <?php
                                            ...
                                            foreach($tampil_data_blk_materi as $erds) {
                                                $no++;
                                                $teori_kali     = $this->M_blk_graha_laundry->ambil_kali('nilai_a_id',$idbio,$erds->id_graha_laundry);
                                                $teori_rata     = $this->M_blk_graha_laundry->ambil_rata($idbio,$erds->id_graha_laundry,'nilai_a');
                                                $praktek_kali   = $this->M_blk_graha_laundry->ambil_kali('nilai_b_id',$idbio,$erds->id_graha_laundry);
                                                $praktek_rata   = $this->M_blk_graha_laundry->ambil_rata($idbio,$erds->id_graha_laundry,'nilai_b');
                                        ?>
                                            <tr>
                                                <td><?php echo $no ?></td>

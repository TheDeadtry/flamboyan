...
class Baru5 extends MX_Controller{

	public function __construct(){
            parent::__construct();
			$this->load->model('m_baru5');
			$this->load->library('Pdf');
	}
	
	function cetak($id_karep) {
    $namanya           = $this->m_baru5->tampil_namanya($id_karep);
    $nama_ibu          = $this->m_baru5->tampil_nama_ibu($id_karep);
    $nama_bapak        = $this->m_baru5->tampil_nama_bapak($id_karep);
    $jeniskelamin     = $this->m_baru5->tampil_jeniskelamin($id_karep);
    $tempatlahir      = $this->m_baru5->tampil_tempatlahir($id_karep);
    $tgllahir         = $this->m_baru5->tampil_tgllahir($id_karep);
    $no_ktpnya        = $this->m_baru5->tampil_no_ktpnya($id_karep);
    $alamatnya        = $this->m_baru5->tampil_alamatnya($id_karep);
    $provinsi         = $this->m_baru5->tampil_provinsi($id_karep);
    $status         = $this->m_baru5->tampil_status($id_karep);
    $agama          = $this->m_baru5->tampil_agama($id_karep);
    $pendidikan       = $this->m_baru5->tampil_pendidikan($id_karep);
    $nama           = $this->m_baru5->tampil_nama($id_karep);
    $mata_uang        = $this->m_baru5->tampil_mata_uang($id_karep);
    $direktur         = $this->m_baru5->tampil_direktur($id_karep);
    $jenisagre        = $this->m_baru5->tampil_jenisagre($id_karep);
    $gajinya        = $this->m_baru5->tampil_gajinya($id_karep);
    $nopaspor        = $this->m_baru5->tampil_paspor($id_karep);
    $berlaku        = $this->m_baru5->tampil_berlaku($id_karep);
    $sampai         = $this->m_baru5->tampil_sampai($id_karep);
    $tgl_berangkatnya   = $this->m_baru5->tampil_tgl_berangkatnya($id_karep);
    $tgl_tibanya      = $this->m_baru5->tampil_tgl_tibanya($id_karep);
  ...
  // Set some content to print
    ...
    $html = '<p align="center">FORMAT PENGISIAN TKI ON LINE</p>
      ...
      <tr>
                ...
                <th colspan="2">:</th>
                <th colspan="35"><strike>EKS</strike> / Baru</th> 
                <th colspan="15">*)</th>             
             </tr>
       <tr>
                <th colspan="3" ></th>
                ...
                <th colspan="2">:</th>
                <th colspan="35"><strike>Formal</strike> / Informal</th> 
                <th colspan="15">**)</th>             
             </tr>
       </table><br><br>

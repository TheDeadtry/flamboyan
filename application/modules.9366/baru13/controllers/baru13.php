...
class baru13 extends MX_Controller{

	public function __construct(){
            parent::__construct();
			$this->load->model('m_baru13');
    ...
    $pdf->SetTitle('SURAT NOTARISAN KELUARGA ( FORMAL )');
    ...
    $html = '<table align="center" style="font-size:20px;">
			 ...
			 <table>
				...
				<th align="center" colspan="4" >1. </th>
					<th colspan="80" >Saya bersedia bekerja di Taiwan sebagai <b><i><u>WORKER</u></i></b> dengan gaji pokok <b>NT$ 19.047</b> /bulan.
...
<b>NT$ 62.780</b> atau <b>Rp 18.406.295,-</b> (Delapan Belas Juta Empat Ratus Enam Ribu Dua Ratus Sembilan Puluh Lima Rupiah) untuk biaya proses, yang pengembaliannya ditetapkan oleh disnaker Indonesia dan Badan Perburuan Taiwan (<b>NT$ 5.886</b> / bulannya untuk total 10 bulan periode) diproses melalui pemotongan gaji oleh Bank Taiwan sesuai perjanjian dengan pihak Bank Taiwan.
  ...
  // ;
	...
	$pdf->Output('SURAT NOTARISAN KELUARGA ( FORMAL ).pdf', 'I');    
    }
}
...
<div class="dropzone">
<a type="button" class="btn" href="<?php echo base_url()."index.php/upload_skckpolres/"?>"><i class=" icon-remove"></i> Kembali </a>
...
url: "<?php echo base_url('index.php/upload_skckpolres/proses_upload') ?>",
maxFilesize: 10,
method:"post",
...
foto_upload.on("removedfile",function(a){
    ...
    $.ajax({
        type:"post",
        data:{token:token},
        url:"<?php echo base_url('index.php/upload_skckpolres/remove_foto') ?>",
        cache:false,
        dataType: 'json',
        success: function(){

                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading bg-slate-800">
                            <h5 class="panel-title"><b><i> Data PAP </i></b></h5>
...
<script type="text/javascript">
    $('#dkrh').dataTable({
        ...
        serverSide: true,
        ajax: {
            "url"       : "<?php echo site_url('blk_rekapitulasi/pap_show') ?>",
            "type"      : "POST"
        }
    });
    ...
    $(document).on("click", ".dkrhsimpantambah", function() {
        ...
        $.ajax({
            url             : "<?php echo site_url('blk_rekapitulasi/pap_insert') ?>",
            type            : "POST",
            dataType        : 'json',
            encode          : true,
            data            : form_data,
    ...
    {
        $.ajax({
            url             : "<?php echo site_url('blk_rekapitulasi/pap_edit') ?>"+"/"+id,
            type            : "POST",
            dataType        : 'json',
            encode          : true,
            data            : {
    ...
    $(document).on("click", ".dkrhsimpanubah", function() {
        ...
        $.ajax({
            url             : "<?php echo site_url('blk_rekapitulasi/pap_update') ?>",
            type            : "POST",
            dataType        : 'json',
            encode          : true,
            data            : form_data,
    ...
    function modal_hapus(id) {
        ...
        function(isConfirm){
            if (isConfirm) {
                $.ajax({
                    url             : "<?php echo site_url('blk_rekapitulasi/pap_delete') ?>",
                    type            : "POST",
                    dataType        : 'json',
                    encode          : true,
                    data            : form_data,

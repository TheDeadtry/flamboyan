		...
		<div class="page-header-content">
			...
			<div class="heading-elements">
				<div class="heading-btn-group">
					<a href="#" class="btn btn-link btn-float has-text"><i class="icon-people"></i> <span>Data Bahasa Taiyu</span></a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="content-wrapper">
				...
				<div id="modal_form_horizontal" class="modal fade">
					<div class="modal-dialog modal-md">
						<div class="modal-content">
							...
							<form action="<?php echo site_url('setting_data_pelatihan/simpan_data_bhs_taiyu'); ?>" class="form-horizontal" method="post">
				...
				<div class="panel panel-flat">
					...
					<table class="table datatable-basic table-bordered table-striped table-hover">
						...
						<tbody>
						<?php $no = 1; 
                            foreach ($tampil_data_bhs_taiyu as $row) { 
                            ?>			
							<tr>
								<td><?php echo $no;?></td>
							...
							<div id="edit<?php echo $no; ?>" class="modal fade" role="dialog">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<form action="<?php echo site_url('setting_data_pelatihan/update_data_bhs_taiyu'); ?>" class="form-horizontal" method="post">										
											<input type="hidden" class="form-control" name="id_bhs_taiyu" value="<?php echo $row['id_bhs_taiyu']; ?>">
											<div class="modal-body">
													<div class="form-group">
														<div class="row">
															<label class="control-label col-sm-3">Kode Materi</label>
							...
							<div id="hapus<?php echo $no; ?>" class="modal fade" role="dialog">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<form action="<?php echo site_url('setting_data_pelatihan/hapus_data_bhs_taiyu'); ?>" class="form-horizontal" method="post">										
											<div class="modal-body">
												<input type="hidden" class="form-control" name="id_bhs_taiyu" value="<?php echo $row['id_bhs_taiyu']; ?>">

...
class blk_olah_raga extends MX_Controller{
	public function __construct(){
            parent::__construct();
			$this->load->model('M_session');			
			$this->load->model('M_blk_olah_raga');			
	}
		...
		$status = $session['session_status'];
			//user sudah login
			 if ($id_user && $status==2){
				...
				$tampil_data_blk_personaldetail = $this->M_blk_olah_raga->tampil_data_blk_personal($pilihan);
				$data['namanya'] = $tampil_data_blk_personaldetail['namanya'];

			 	//$data['tampil_data_olah_raga'] 	= $this->M_blk_olah_raga->tampil_data_olah_raga($idbio);
			 	$data['tampil_data_blk_instruktur'] = $this->M_blk_olah_raga->tampil_data_select('blk_instruktur');
			 	$data['tampil_data_blk_nilai'] 		= $this->M_blk_olah_raga->tampil_data_select('blk_nilai');
			 	$data['tampil_data_blk_materi'] 	= $this->M_blk_olah_raga->tampil_data_select('blk_pelajaran_olah_raga');
			 	$data['tampil_data_blk_minggu'] 	= $this->M_blk_olah_raga->tampil_data_select('blk_minggu');
				$data['tampil_data_group'] 			= $this->M_blk_olah_raga->tampil_group();
				$data['count_total'] 				= $this->M_blk_olah_raga->count_row('blk_penilaian_olah_raga',$idbio,'nilai_id');
				$data['t_nilai'] 					= $this->M_blk_olah_raga->sum_row('blk_penilaian_olah_raga',$idbio,'nilai_id');

				$data['namamodule'] = "blk_olah_raga";
				$data['namafileview'] = "blk_olah_raga";
	...
	function tambah_nilai($no) {
		...
		$this->M_blk_olah_raga->tambah_nilai($data);
		redirect('blk_olah_raga/index/'.$no);
	}
	...
	function ubah_nilai($no) {
		...
		$this->M_blk_olah_raga->ubah_nilai($data,$id);
		redirect('blk_olah_raga/index/'.$no);
	}

	function hapus_nilai($no) {
		$this->M_blk_olah_raga->hapus_nilai();
		redirect('blk_olah_raga/index/'.$no);
	}
	...
	function coba($idbio) {
		...
		$tampil_data_group 			= $this->M_blk_olah_raga->tampil_group();

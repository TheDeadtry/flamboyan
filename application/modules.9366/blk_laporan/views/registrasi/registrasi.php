                        ...
                        <div class="panel">
                            <div class="panel-heading bg-indigo">
		                        <h5 class="panel-title">
		                        	Laporan CTKW Registrasi
		                        </h5>
                                <div class="heading-elements">
                                </div>     
                            </div>
                            <div class="panel-body">	
                            	<form target='_blank' action="<?php echo site_url('blk_laporan/registrasi_print') ?>" enctype="multipart/form-data" method="post"/>

			                        <div class="form-group">
			                        	<div class="row">
				                            <label class="control-label col-md-2">Tanggal Registrasi Dari</label>
				                            <div class="col-md-5">
			                        ...
			                        <div class="form-group">
			                        	<div class="row">
				                            ...
				                            <div class="col-md-10">
				                            	<select name="sektor" class="dewselect2_n">
			                        ...
			                        <div class="text-right">
			                            <button type="submit" class="btn btn-primary">Print Laporan Registrasi <i class="icon-arrow-right14 position-right"></i></button>
			                        </div>

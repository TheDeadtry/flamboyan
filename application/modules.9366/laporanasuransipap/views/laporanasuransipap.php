<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h2> <span class="text-semibold">Laporan Asuransi Pra PAP </span></h2>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        <div class="panel-heading bg-blue-400">
                            <h5 class="panel-title text-center"><b><i>Laporan Asuransi Pra PAP </i></b></h5>
                            <div class="heading-elements">
                            </div>
                        </div>

                        <div class="panel-body">   
                            <form class="form-horizontal" method="post" action="<?php echo site_url('laporanasuransipap/filtertanggalawal'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a target="_blank"  class="btn btn-info btn-large" href="<?php echo base_url(); ?>index.php/pdf13/cetak22filter?bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun;?>"> PRINT </a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="panel-body"> 
                            <table class='table table-bordered' style='margin-bottom:0;'>
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1; 
                                        foreach ($tampil_data_detail2filter as $row) { 
                                    ?>
                                            <tr>
                                                <td><?php echo $no;?></td>

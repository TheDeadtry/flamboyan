...
class Pdf12 extends MX_Controller{

	public function __construct(){
            parent::__construct();
			$this->load->model('m_pdf12');
    ...
    $html = '<table align="center" width="100%" cellspacing="0" cellpadding="2" border="0">
			...
			<table align="left" width="100%" cellspacing="0" cellpadding="2" border="0">
				<tr>
					<th align="center" colspan="73" >Pada hari ini SABTU tanggal 30 bulan Mei tahun 2015 telah diadakan Perjanjian Penempatan antara :</th>      
				</tr>
				<br>
				<tr>
					<th colspan="2" >1</th>

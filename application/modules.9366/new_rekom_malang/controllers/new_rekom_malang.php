...
class new_rekom_malang extends MX_Controller{
	...
	function table_show() 
	{
	    ...
	    foreach ($tampil_data as $row) 
	    {
            ...
            array_push($data2,
                array(
                    $no,
					'<a class="btn btn-xs bg-orange" target="_blank" href="'.site_url('new_rekom_malang/print_pdf/'.$row->id_pembuatan).'">PRINT</a> 
	...
	function print_pdf($id) 
	{
	    ...
	    foreach ( $tki_exp as $vall )
	    {
	    	...
	    	$tampildata .= "\n".'<tr>';
	    	$tampildata .= "\n\t".'<th colspan="2">'.$no.'</th>';
	    	$tampildata .= "\n\t".'<th colspan="9">'.$ambil_data_ext->disnaker_nama.'</th>';
	    	$tampildata .= "\n\t".'<th colspan="4">'.$ambil_data_ext->disnaker_jk.'</th>';
	    	$tampildata .= "\n\t".'<th colspan="6">'.$ambil_data_ext->disnaker_t.'<br/>'.$disnaker_tl.'</th>';
	    	$tampildata .= "\n\t".'<th colspan="10">'.$ambil_data_ext->disnaker_alamat.'</th>';
	    	$tampildata .= "\n\t".'<th colspan="5">'.$ambil_data_ext->disnaker_tujuan.'</th>';
	    	$tampildata .= "\n".'</tr>';

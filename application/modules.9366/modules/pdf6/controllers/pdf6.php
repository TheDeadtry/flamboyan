...
class pdf6 extends MX_Controller{

	public function __construct(){
            parent::__construct();
			$this->load->model('m_pdf6');
    ...
    $html = ' <table align="left" width="95%" cellspacing="0" cellpadding="2" border="0">				
				<tr>
					<th colspan="4"></th> 
					<th colspan="8"></th> 
					<th colspan="3"></th> 
				...
				<tr>
					...
					<th colspan="8"></th> 
					<th colspan="4"></th> 
					<th colspan="20">Yth. Kepala Dinas Tenaga Kerja</th> 
				</tr>
				<tr>
					<th colspan="4"></th> 
					...
					<th colspan="8"></th> 
					<th colspan="4"></th> 
					<th colspan="25 ">Jl. Jayeng Kusuma No.19 Tulungagung </th> 
				</tr>
				<tr>
					<th colspan="4"></th> 
					<th colspan="8"></th> 

...
class setting_pendidikan extends MX_Controller{
	...
	$session = $this->M_session->get_session();
		...
		$status = $session['session_status'];
			...
			//user sudah login
				...
				$data['tampil_data_dokdibawa'] = $this->M_pendidikan->tampil_data_dokdibawa();
				$data['namamodule'] = "setting_pendidikan";
	...
	function simpan_data_dokdibawa(){
		...
		$this->M_pendidikan->simpan_data_dokdibawa();

		redirect('setting_pendidikan');
	}

	function update_data_dokdibawa() {
			$this->M_pendidikan->update_data_dokdibawa();
			redirect('setting_pendidikan');
	}

	function hapus_data_dokdibawa($id) {
		$this->M_pendidikan->hapus_data_dokdibawa($id);
		redirect('setting_pendidikan');
	}
}
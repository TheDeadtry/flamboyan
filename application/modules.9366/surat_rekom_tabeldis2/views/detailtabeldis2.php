...
<div class="page-container">
                    ...
                    <div class="panel panel-bordered">
                        <div class="panel-heading bg-blue-400">
                            ...
                            <div class="heading-elements">
                                ...
                                <a href="<?php echo site_url('surat_rekom_tabeldis/'); ?>" class='btn bg-warning-800 btn-large' type="button">Kembali</a>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="editvv" role="dialog">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo site_url('surat_rekom_tabeldis/update_tabeldis/'.$id_pembuatan) ?>">
                        ...
                        <div class='modal fade' id='tambahagama' role='dialog'>
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo site_url('surat_rekom_tabeldis/simpan_data_tabeldis/'.$id_pembuatan);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                        <div class='modal-body'>
    ...
    <script type="text/javascript">
        $('#fixedeks').dataTable({ 
            ...
            serverSide: true,
            ajax: {
                "url"       : "<?php echo site_url('surat_rekom_tabeldis/show_data_detail/'.$id_pembuatan) ?>",
                "type"      : "POST"
            }
        });
        ...
        function edit999(id) {
            $.ajax({
                url: '<?php echo site_url('surat_rekom_tabeldis/edit_detail_show') ?>',
                type: 'POST',
                dataType: 'json',
                data: 'id='+id,
                encode:true,

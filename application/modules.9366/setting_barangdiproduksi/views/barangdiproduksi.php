...
<div class="col-lg-12">
            <h5 class="panel-title text-center ">SETTING BARANG DI PRODUKSI<br> </h5><br/>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info ubah-kategori"
                      ...
                      data-isi1 = "<?php echo $value->isi; ?>"
                    >ubah</a>
                    <a data-id = "<?php echo $value->id ?>" class="btn btn-danger hapus">Hapus</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
...
<form action="<?php echo site_url(); ?>/setting_barangdiproduksi/update_data_dokdibawa" method="POST">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              <label>Nama</label>
              <input style="width: calc(100% - 10px);" type="text" class="form-control" id="isi1" name="isi">
          </div>
      </div>
...
<form action="<?php echo site_url(); ?>/setting_barangdiproduksi/simpan_data_dokdibawa" method="POST">
  ...
  $("body").click(function(e) {
    ...
    if (target.is('.hapus')) {
       var id = target.attr("data-id");
        ...
        if (r == true) {
          location.href = "<?php echo site_url(); ?>/setting_barangdiproduksi/hapus_data_dokdibawa/"+id;
        } else {

            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h2> <span class="text-semibold">PRINT ASURANSI MASA PAP </span></h2>
                    </div>
...
<div class="page-container">
    <div class="page-content">
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form class="form-horizontal" method="post" action="<?php echo site_url('surat_rekom_tabeldis3/setid'); ?>">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <a href="<?php echo base_url()."index.php/surat_rekom_tabeldis3/setsemua"?>" role="button" class="btn btn-info btn-large">Semua</a>
                                </div>
                            </div>
                        </div>
                    </form>
                    <div class="panel panel-bordered">
                        <div class="panel-heading bg-blue-400">
                            <h5 class="panel-title">
                                <div class='title'>DATA ASURANSI MASA PAP</div> <br>
                            </h5>
                            <div class="heading-elements">
    ...
    <div id="myModal1" class="modal fade" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url('surat_rekom_tabeldis3/simpan_data_surat/');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                    ...
                    <div id="myModal2" class="modal fade" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo site_url('surat_rekom_tabeldis3/edit_surat/');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                    <div class="modal-body">
    ...
    <script type="text/javascript">
        $('#suveringtos').dataTable({
            ...
            serverSide: true,
            ajax: {
                "url"       : "<?php echo site_url('surat_rekom_tabeldis3/show_data/') ?>",
                "type"      : "POST"
            }
        });
        ...
        function edit777(id) {
            $.ajax({
                url: '<?php echo site_url('surat_rekom_tabeldis3/edit_show') ?>',
                type: 'POST',
                dataType: 'json',
                data: 'id='+id,
                encode:true,

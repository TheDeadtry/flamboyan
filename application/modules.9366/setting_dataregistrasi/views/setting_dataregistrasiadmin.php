...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header orange-background'>
                                <div class='title'>Data Tempat Registrasi</div>
                                <div class='actions'>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url('setting_dataregistrasi/update_data'); ?>">
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('setting_dataregistrasi/hapus_data'); ?>">
                           <div class="modal-header">
                           ...
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id" value="<?php echo $row->id; ?>">
                              <p>Apakah anda yakin akan menghapus data Keterangan ini? : <?php echo $row->nama; ?></p>
                           </div>
                           <div class="modal-footer">
                             <button type="submit" class="btn btn-primary" name="submit">Submit</button>
                             <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
...
<?php echo form_open('agama/simpan_data_agama', array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                ...
                <div class='modal-body'>
<form action="<?php echo site_url('setting_dataregistrasi/simpan_data');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />

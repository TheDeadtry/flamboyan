        ...
        ?>
            ...
            <div class="span6">
                ...
                <div class="alert alert-info">
                    <button data-dismiss="alert" class="close"> x </button> silahkan mengubah data pada tombol ini... <a
                        href="<?php echo base_url()."index.php/detailpersonal/ubahpersonal/"?>" class="btn btn-mini
            ...
            <div class="span3">
                ...
                <div class="control-group">
                    <div class="controls">
                        <input type="text" class="span12" value="<?php echo $row->statusaktif;?>" data-trigger="hover"
                            name="status" data-content="Status TKI saat INI" data-original-title="STATUS" readonly />
                    </div>
                </div>
                ...
                <ul class="unstyled">
                    ...
                    <li>
                        <a class="btn btn-primary"
                            href="<?php echo site_url('biodata_cong_yi').'/print_bio/'.$detailpersonalid; ?>"
                            target="_blank">
                            BIODATA FORMAL (DOCX)
                        </a>
                    </li>
                    <li>
                        <a class="btn btn-primary"
                            href="<?php echo site_url('detailisichongyi/printdata/'.$detailpersonalid); ?>"
                            target="_blank">
            ...
            <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
                ...
                <div class="modal-body">
                    <form action="<?php echo site_url('detailpersonal/ubahstatus');?>" enctype="multipart/form-data"
                        method="post" class="form-horizontal" />
                    <div class="control-group">
                        <label class="control-label">ID BIODATA</label>
                        <div class="controls">
                            <input type="text" readonly name="idp" value="<?php echo $detailpersonalid; ?>" required
                                class="span7 popovers" data-trigger="hover"
...
<div class='modal hide fade' id='uploadfoto' role='dialog' tabindex='-2'>
    ...
    <div class='modal-body'>
        <form action="<?php echo site_url('tambahmedical/tambahmedicaldata');?>" enctype="multipart/form-data"
            method="post" class="form-horizontal" />
        ...
        <div id="upload-wrapper">
            <div align="center">
                ...
                <form action="processupload.php" onSubmit="return false" method="post" enctype="multipart/form-data"
                    id="MyUploadForm">

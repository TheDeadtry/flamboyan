				...
				<div id="modal_form_horizontal" class="modal fade">
					<div class="modal-dialog modal-md">
						<div class="modal-content">
							...
							<form action="<?php echo site_url('setting_data_pelajaran/simpan_data_jompo'); ?>" class="form-horizontal" method="post">
							...
							<div id="edit<?php echo $no; ?>" class="modal fade" role="dialog">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<form action="<?php echo site_url('setting_data_pelajaran/update_data_jompo'); ?>" class="form-horizontal" method="post">										
							...
							<div id="hapus<?php echo $no; ?>" class="modal fade" role="dialog">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<form action="<?php echo site_url('setting_data_pelajaran/hapus_data_jompo'); ?>" class="form-horizontal" method="post">										
											<div class="modal-body">
												<input type="hidden" class="form-control" name="id_jompo" value="<?php echo $row['id_jompo']; ?>">

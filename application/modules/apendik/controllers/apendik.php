...
// ------------------------------------------- download file --------------------------------------------------------------//
        echo "
        <script>
            location.href = '".site_url('apendik/hasil/'.$key.'/'.$kategori.'/'.$namannya)."';
        </script>
        ";
        
        // echo 'apendik/hasil/'.$key.'/'.$kategori.'/'.$namannya;
    ...
    function hasil($key, $kategori, $nama){
        ...
        echo '<script>setTimeout(()=>{ window.close(); console.log("ok")})</script>';
        exit;
    }
...
//  ------------------------------------------- save file ------------------------------------------------------------------//
        ...
        if(file_exists($tmp_file)){
            ...
            header('Content-Type: application/vnd.openxmlformats-officedocument.wordprocessingml.document');
            header('Content-Disposition: attachment; filename='.$key.'.docx');
            readfile($tmp_file);
        }

            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="<?php echo site_url('markformal/setpilih'); ?>">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="btn-group btn-group-animated">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo site_url('markformal/tampidatagroupnya'); ?>"><i class="icon-person"></i>  已經入境 – SUDAH KE TAIWAN</a></li>
                                        </ul>
                                    </div>
                                    <a class="btn bg-pink-700" href="<?php echo site_url('admin_print/markformal_print') ?>" target="_blank">PRINT (xls)</a>
                                </div>
                            </div>
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">PROGRESS MARKETING PABRIK-JOMPO - 工廠+養護機構 -進度表. <br/>還沒入境 – BELUM KE TAIWAN</h5>
                        <div class="heading-elements">
                            <ul class="icons-list">
                                <li><a data-action="collapse"></a></li>
                                <li><a data-action="reload"></a></li>

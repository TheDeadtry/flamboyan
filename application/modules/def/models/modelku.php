...
class Modelku extends CI_Model {
    ...
    $data = $this->db->query("
      ...
      $settdatakehasil
            ...
            AND (
                ...
                OR personal.id_biodata LIKE '%MH%'
                OR personal.id_biodata LIKE '%MC%'
                OR personal.id_biodata LIKE '%FH%'
    ...
    $data = $this->db->query("
            ...
            AND (
                ...
                OR personal.id_biodata LIKE '$fill02'
                OR personal.id_biodata LIKE '$fill03'
                OR personal.id_biodata LIKE '$fill04'
                OR personal.id_biodata LIKE '$fill05'
                OR personal.id_biodata LIKE '$fill06'
            ) $pencarian 
        ")->result();
    return count($data);
    }

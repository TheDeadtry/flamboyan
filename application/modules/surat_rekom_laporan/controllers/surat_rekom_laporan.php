...
class surat_rekom_laporan extends MX_Controller{
	    ...
	    foreach ($tampil_data_pengajuan as $row) {
            ...
            array_push($data2,
                array(
		            ...
		            '<a href="'.base_url().'index.php/pdf7/cetakan05/'.$row->id_pembuatan.'"  class="btn btn-warning">Print</a> '.
		            '<!--<a href="'.base_url().'index.php/surat_rekom_laporan/cetakan05v2/'.$row->id_pembuatan.'"  class="btn bg-orange">Print (BANK)</a>-->',
		            $row->nomor,
		            $row->tanggal,

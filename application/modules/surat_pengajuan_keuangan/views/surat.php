                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <select id="pilihbank" required name="lembaga" class="form-control">
                                    <option value="">Pilih Bank</option>
                                    <?php foreach ($this->db->query("SELECT * FROm databank")->result() as $key => $data) : ?>
                                        <option value="<?= $data->mandarin ?>"><?= $data->mandarin ?></option>
                                    <?php endforeach ?>
                                </select>
                                <script>
                                    $("#pilihbank").select2();
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-lg-12 control-label">Lembaga </label>
                            <div class="col-lg-12">
                                <select id="elembaga" required name="lembaga" class="form-control">
                                    <option value="">Pilih Bank</option>
                                    <?php foreach ($this->db->query("SELECT * FROm databank")->result() as $key => $data) : ?>
                                        <option value="<?= $data->mandarin ?>"><?= $data->mandarin ?></option>
                                    <?php endforeach ?>

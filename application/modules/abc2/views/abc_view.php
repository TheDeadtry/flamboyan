        ...
        <div class="content-wrapper">
            <div class="row">
                <div id='style-judul' class="col-lg-12">
                    <h1><i style="font-size: 20px; color: red;" class="icon-star-full2"></i> PROGRESS MARKETING MALAYSIA</h1>
                    <h3 id="judul"></h3>
                </div>
                <div class="col-lg-12">
                            ...
                            <table id="example" class="display" style="width:100%">
                                <thead>
                                     <tr>
                                        ...
                                        <th class="fixed-side orange"></th>
                                        <th class="fixed-side orange"></th>
                                        <th rowspan="2" colspan="2" class="orange">Keterangan</th>
                                        <th class="orange"></th>
                                        <th class="orange"></th>
                                        ...
                                        <th colspan="26" class="blue">PROSES DOK DI INDONESIA (印尼文件）</th>
                                      </tr>
                                      <tr>
                                        <th colspan="3" class="fixed-side orange">外勞 - TKI</th>
                                        <th colspan="2" class="orange">雇主</th>
                                      ...
                                      <tr>
                                        ...
                                        <th colspan="2" class="orange">備註</th>
                                        <th colspan="2" class="orange">MAJIKAN</th>
                                        ...
                                        <th rowspan="2" class="orange">完整 SELESAI DURASI</th>
                                        ...
                                        <th rowspan="2" class="blue">受訓 PAP <br> 外勞卡 KTKLN</th>
                                      ...
                                      <tr>
                                        ...
                                        <th class="orange">Keterangan 1</th>
...
$(document).ready(function() {
  ...
  session("keyGroup", "all");
	...
	session("search", "");
  	jsonparse();
	$("<input type='text' id='pencarian' placeholder='search' focus>").insertBefore(".ggs");
	$("<div class='gugus_pagin'></div>").insertAfter(".ggs-table");

  setTimeout(() => {
    $("#pencarian").on('keyup', delay(function(){
      search()
    },500))
  }, 100);
...
$("#open-modal").click(function(){
  ...
  $.ajax({
      url: "<?= site_url(); ?>/abc2/dataGroupAgen",
...
function perkiraan(key){
  ...
  $.ajax({
    url: "<?= site_url(); ?>/abc2/simpanperkiraan/"+id+"/"+key,
    success:function(response){
      alert(response);
    }
  })
...
function keteranganPerkiraan(key){
  ...
  $.ajax({
    url: "<?= site_url(); ?>/abc2/keterangan_simpanperkiraan/"+id+"/"+key,
    success:function(response){
      alert(response);
    }
  })
...
$("#print-modal").click(function(){
  ...
  location.href = '<?= site_url(); ?>/abc2/printData/'+nilai+'/'+nilaiDua+'/'+sesi+'/';
});
...
function jsonparse(){
  ...
  var kondisiData = getSession("kondisiData");
	...
	var Datahalaman = '';
	$.ajax({
		url: "<?= site_url(); ?>/abc2/json/"+limit+"/"+search,
		method: "POST",
		dataType: "text",
    data:{
...
function editdata(){
  $(".myBtn").click(function(){
    ...
    var modalKe = $(this).attr("modal-ke");
    sessionStorage.setItem("modal", modalKe);
    $("#"+modal).css({"display":"block"});
    jalankan();
    var dataId = $(this).attr("data-id");
    var isinya = $(this).attr("data-isi");
    $("textarea[name=keterangan1]").text(isinya);
  })
}

<?php
    // backup keterangan
    // $this->db->query("
    //     INSERT INTO backup_keterangan_personal
    //     SELECT p.id_personal, p.keterangan FROM personal p
    //     LEFT JOIN backup_keterangan_personal b ON p.id_personal = b.id_personal
    //     WHERE p.keterangan <> 0 AND b.id_personal IS NULL
    // ");
?>
<!DOCTYPE html>
<html lang="en">
...
<!--
    ...
    <script src="<?= base_url("assets/xlsx.js") ?>"></script>

...
<head>
    ...
    <!-- Global stylesheets -->
    <noscript id="macina">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</noscript>
    ...
    <style type="text/css">
        ...
        .differentTable > thead > tr > th,
        .differentTable > thead > tr > td {
            border: 1px solid black;
            padding:12px 20px;
        }
        .differentTable > tbody > tr > td,
        .differentTable > tbody > tr > th {
            border: 1px solid black;
            padding:5px 10px;
        }

        .differentTable > tfoot > tr > th,
        .differentTable > tfoot > tr > td {
            border: 1px solid black;
            padding:12px 20px;
        }
    </style>
     ...
     <script>
        ...
        const getDataTable = function(qr){
            return new Promise((resolve,reject)=>{
                AuditDevQuery(token, qr, function(e){
                    resolve(e);
                })
            });
        }
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/blk/assets/js/plugins/forms/selects/bootstrap_select.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/blk/assets/js/pages/form_bootstrap_select.js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url('xlsx2.min.js?v=1') ?>"></script>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dewa/toastr/toastr.min.css" />
    <script src="<?php echo base_url(); ?>assets/dewa/toastr/toastr.min.js" ></script>
</head>

<body onload="typeof process === 'function'?process():null">
    ...
    <div class="navbar navbar-inverse">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php 
                    $this->load->view("template/notofikasi")
                ?>
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="<?php echo site_url().'/logout/change'; ?>"><i class="icon-user-plus"></i> Move ADMIN</a></li>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="<?php echo site_url().'/blk_personal'; ?>" >
                        <i class="icon-users4"></i> Personal BLK </span>
                    </a>                    
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu width-250">
                        ...
                        <li>
                            <a href="<?php echo site_url().'/ujk_print'; ?>"><i class="icon-printer2"></i> Print Laporan UJK</a>
                        </li>
                 ...
                 <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-book3"></i> Rekapitulasi <span class="caret"> </span>
                    </a>   
                    ...
                    <ul class="dropdown-menu width-250">
                        ...
                        <!--
                        <li>
                            <a href='<?php //echo site_url().'/blk_rekapitulasi/absensi'; ?>'><i class="icon-task"></i> Absensi [ERROR]</a>
                        </li>
                        <li>
                            <a href='<?php //echo site_url().'/blk_rekapitulasi/ijin'; ?>'><i class="icon-task"></i> IP & IJ [ERROR]</a>
                        </li>
                        <li>
                            <a href='<?php //echo site_url().'/blk_rekapitulasi/pkl'; ?>'><i class="icon-task"></i> PKL [ERROR]</a>
                        </li>
                        <li>
                            <a href='<?php //echo site_url().'/blk_rekapitulasi/jompo'; ?>'><i class="icon-accessibility2"></i> Praktek Jompo [ERROR]</a>
                        </li>
                        <li>
                            <a href='<?php //echo site_url().'/blk_rekapitulasi/tata_boga'; ?>'><i class="icon-wave2"></i> Praktek Tata Boga [ERROR]</a>
                        </li>-->
                        <li>
                            <a href='<?php echo site_url().'/blk_finger_new/database'; ?>'><i class="icon-touch"></i> Database Fingerspot </a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_finger_new'; ?>'><i class="icon-touch"></i> Backup Fingerspot </a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_finger_new/manual'; ?>'><i class="icon-touch"></i> Manual Backup Fingerspot </a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_finger_new/cetak'; ?>'><i class="icon-touch"></i> Cetak Fingerspot </a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/finger'; ?>'><i class="icon-touch"></i> Fingerprint TKI </a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/finger_waktu'; ?>'><i class="icon-touch"></i> Fingerprint TKI (Waktu)</a>
                        </li><!--
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/finger/informal'; ?>'><i class="icon-touch"></i> Fingerprint TKI Informal (FI, MI)</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/finger/pjompo'; ?>'><i class="icon-touch"></i> Fingerprint TKI Panti Jompo (JP)</a>
                        </li>-->
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/kb'; ?>'><i class="icon-theater"></i> KB</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/ik'; ?>'><i class="icon-exit"></i> Ijin Keluar</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/ii'; ?>'><i class="icon-bed2"></i> Ijin Inap</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/ip'; ?>'><i class="icon-exit3"></i> Ijin Pulang</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/ith'; ?>'><i class="icon-cancel-circle2"></i> Ijin Tidak Hadir</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/pkl'; ?>'><i class="icon-switch22"></i> PKL</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/pap'; ?>'><i class="icon-switch22"></i> PAP</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/teto'; ?>'><i class="icon-switch22"></i> TETO</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url().'/blk_rekapitulasi/noticetki'; ?>'><i class="icon-switch22"></i> NOTICE TKI</a>
                        </li>
                 ...
                 <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-book3"></i> Laporan <span class="caret"> </span>
                    </a>   
                    ...
                    <ul class="dropdown-menu width-250">
                        ...
                        <li><a href="<?php echo site_url().'/blk_sertifikat'; ?>">Sertifikat</a></li>
                        <li><a href="<?php echo site_url().'/blk_laporan/registrasi'; ?>">Registrasi</a></li>
                    </ul>
                </li>
                    ...
                    <div class="dropdown-menu dropdown-content">
                        <div class="dropdown-content-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <span class="menu-heading underlined">Setting Data Adm</span>
                                    <ul class="menu-list">
                                        <li>
                                        ...
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/sektor'; ?>'><i class=""></i> Sektor Non Taiwan</a>
                                        </li>
                                ...
                                <div class="col-md-3">
                                    <span class="menu-heading underlined">Setting Data Pembinaan PMI</span>
                                    <ul class="menu-list">
                                        <li>
                                       ...
                                       <li>
                                        ...
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/nilai'; ?>'><i class="icon-percent"></i> Nilai</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/minggu'; ?>'><i class="icon-calendar"></i> Minggu</a>
                                        </li><!--
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/hari'; ?>'><i class="icon-calendar52"></i> Hari</a>
                                        </li>-->
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/jam'; ?>'><i class="icon-alarm"></i> Jam</a>
                                        </li><!--
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/lokasi'; ?>'><i class="icon-location4"></i> Lokasi</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/berat'; ?>'><i class="icon-rotate-ccw"></i> Berat</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/waktu'; ?>'><i class="icon-hour-glass"></i> Waktu</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/jadwal'; ?>'><i class=""></i> Jadwal [Maintance]</a>
                                        </li>-->
                                        <li>
                                            <a href='<?php echo site_url().'/setting_adm_blk/alasan_izin_belajar_read'; ?>'><i class="icon-exit"></i> Alasan Izin Pembelajaran</a>
                                        </li>
                                        
                                    </ul>
                                </div>
                                <div class="col-md-3">
                                    <span class="menu-heading underlined">Pelajaran</span>
                                    <ul class="menu-list">
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/fisik_mental'; ?>'><i class="icon-brain"></i> Fisik Mental (FI,MI,JP,MF,FF)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/mandarin_inf_jompo'; ?>'><i class="icon-bookmark"></i> Mandarin Informal-Jompo (FI,MI,JP)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/bhs_taiyu'; ?>'><i class="icon-tumblr2"></i> Bahasa Taiyu (FI,MI,JP)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/jompo'; ?>'><i class="icon-accessibility2"></i> Jompo (FI,MI,JP)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/graha_laundry'; ?>'><i class="icon-shutter"></i> Graha Laundry (FI,MI)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/graha_ruang'; ?>'><i class="icon-cube"></i> Graha Ruang (FI,MI)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/graha_boga'; ?>'><i class="icon-ampersand"></i> Graha Boga (FI,MI)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/tata_boga'; ?>'><i class="icon-wave2"></i> Tata Boga (FI,MI)</a>
                                        </li><!--
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/psikotest'; ?>'><i class="icon-puzzle3"></i> Psikotest (FI,MI,JP,MF,FF)</a>
                                        </li>-->
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/mandarin_pabrik'; ?>'><i class="icon-book3"></i> Mandarin Pabrik (MF,FF)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/olah_raga'; ?>'><i class="icon-dribbble"></i> Olah Raga (MF,FF)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/berhitung'; ?>'><i class="icon-seven-segment-4"></i> Berhitung (MF,FF)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/umum'; ?>'><i class="icon-deviantart"></i> Umum (FI,MI)</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/graha_ps'; ?>'><i class="icon-deviantart"></i> Graha Pagi/Sore</a>
                                        </li>
                                        <li>
                                            <a href='<?php echo site_url().'/setting_data_pelajaran/teori_boga'; ?>'><i class=""></i> Teori Boga (FI,MI)</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <li class="dropdown ">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-city"></i> &nbsp; Data Angkatan <span class="caret"> </span>
                    </a>   

                    <ul class="dropdown-menu width-250"><!--
                        <li><a href="<?php echo site_url().'/blk_jadwal2'; ?>"><i class="icon-package"></i>Data Paket</a></li>
                        <li><a href="<?php echo site_url().'/blk_jadwal2/jadwal'; ?>"><i class="icon-calendar5"></i>Jadwal</a></li>-->
                        <li><a href="<?php echo site_url().'/blk_angkatan_print'; ?>"><i class="icon-movie"></i>Data Angkatan</a></li>
                    </ul>
                </li>
                
                <li class="dropdown">
                    <a href="<?php echo site_url().'/blk_jadwal/paket'; ?>">
                        <i class="icon-book3"></i> Jadwal BLK
                    </a>   
                </li>

                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-book3"></i> Denah <span class="caret"> </span>
                    </a>   

                    <ul class="dropdown-menu width-250">
                        <li><a href="<?php echo site_url().'/blk_denah/mes1'; ?>"><i class="icon-package"></i>MES Kecil TKL</a></li>
                        <li><a href="<?php echo site_url().'/blk_denah/mes2'; ?>"><i class="icon-package"></i>MES Besar</a></li>
                        <li><a href="<?php echo site_url().'/blk_denah/mes3'; ?>"><i class="icon-package"></i>MES 3</a></li>
                        <li><a href="<?php echo site_url().'/blk_denah/mes4'; ?>"><i class="icon-package"></i>MES 4</a></li>
                        <li><hr/></li>
                        <li><a href="<?php echo site_url().'/blk_denah/ranjang_blk'; ?>"><i class="icon-package"></i>Ranjang Tidur BLK</a></li>
                        <li><a href="<?php echo site_url().'/blk_denah/ruang_staff'; ?>"><i class="icon-calendar5"></i>Ruang Staff Taiwan</a></li>
                    </ul>
                </li>

                <li class="dropdown">
                    <a href="<?php echo site_url().'/blk_psikolog'; ?>">
                        <i class="icon-book3"></i> Psikotes 
                    </a>   
                </li>

                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-book3"></i> Inventaris <span class="caret"> </span>
                    </a>   

                    <ul class="dropdown-menu width-250">
                        <li><a href="<?php echo site_url().'/blk_inventaris/inventaris'; ?>"><i class="icon-bookmark"></i>Data Inventaris</a></li>
                        <li><a href="<?php echo site_url().'/blk_inventaris/barang'; ?>"><i class="icon-cube"></i>Setting Barang</a></li>
                    </ul>
                </li>
                <?php
                    $this->load->view('blk/menu');
                ?>
            </ul>
...
$('#Shipper').change(function() {
    ...
    $(".jsess_nama").val([1]).trigger("change");
    if (selectedOption.data('jeniskelamin') == 1) {
        $(".jsess_jk").val(["Laki-Laki"]).trigger("change");
    } else if (selectedOption.data('jeniskelamin') == 2) {
        $(".jsess_jk").val(["Perempuan"]).trigger("change");
    } else if (selectedOption.data('jeniskelamin') == 3) {
        $(".jsess_jk").val(null).trigger("change");
    }
    $("#cobaa").val(selectedOption.data('jeniskelamin'));
...
$('#tatagraha_ubah').on('show.bs.modal', function (event) {
    ...
    $(".styled, .multiselect-container input").uniform({
        radioClass: 'choice'
            ...
            {
                newwindow=window.open(url,'name','height=500,width=1000, left=139, top=64, scrollbars, resizable=0');

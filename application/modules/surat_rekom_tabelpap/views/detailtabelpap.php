                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo site_url('surat_rekom_tabelpap/simpan_data_tabelpap/'.$id_pembuatan);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                        <div class='modal-body'>
                                            ...
                                            <div class="form-group" id="ctki6">
                                                <label class="control-label col-sm-3"> PILIH CTKI (PETERNAKAN) </label>
                                                <div class="col-sm-9">
                                                    <select class="select-search" name="id6" data-placeholder="Choose a Category" id="xdetail_ctki6">
                                                        <option value="" />
                                                        <?php  foreach ($tampil_data_fh as $pilihan) { ?>
                                                        <option value="<?php echo $pilihan->id_biodata;?>" /><?php echo $pilihan->id_biodata." <br>".$pilihan->nama;?>
                                                        <?php } ?> 
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group" id="ctki6">
                                                <label class="control-label col-sm-3"> PILIH CTKI (MALE CONSTRUCTION) </label>
                                                <div class="col-sm-9">
                                                    <select class="select-search" name="id7" data-placeholder="Choose a Category" id="xdetail_ctki7">
                                                        <option value="" />
                                                        <?php  foreach ($tampil_data_mc as $pilihan) { ?>
                                                        <option value="<?php echo $pilihan->id_biodata;?>" /><?php echo $pilihan->id_biodata." <br>".$pilihan->nama;?>
                                                        <?php } ?> 
                                                    </select>
                                                </div>

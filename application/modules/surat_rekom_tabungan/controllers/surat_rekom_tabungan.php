...
class surat_rekom_tabungan extends MX_Controller{
			...
			array_push($data2,
				array(
                    $i,
                    	...
                    	'<a class="btn btn-xs bg-orange-600" href="'.site_url('surat_rekom_tabungan/printdata/'.$row->id_pembuatan).'">PRINT</a>',
                    $row->id_biodata,
                    $row->nama,

    ...
    <!-- /page header -->
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="<?php echo site_url('cetak_laprekdisnaker/cetaklap');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <select class="select-results-color" name="piltip">
                                    <option value="PR"/> TGL ONLINE
                                    <option value="PD"/> TGL BUAT
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <select class="select-results-color" name="pilsek">
                                    <option value="FI"/> Formal Informal
                                    <option value="NFI"/> (MF,FF,MI & JP)
                                </select>
                            </div>
                        </div>

        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload JD  </li>
                </ul>
            </div>
        </div>
    </div>
...
<?php if($hitungan==0){?>
               <div class="row-fluid">
                            ...
                            <div class='box-header orange-background'>
                                <div class='title'>Data UPLOAD JD</div>
                                <div class='actions'>
                                    <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                    </a>
                                    <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <form action="<?php echo site_url('upload_kpapra/simpan_data_kpapra');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
...
<?php foreach ($tampil_data_kpapra as $row) { ?>
                            <form action="<?php echo site_url('upload_kpapra/update_data_kpapra');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
<input type="hidden" class="form-control" name="id_kpapra" value="<?php echo $row->id_kpapra; ?>">
        ...
        <div class='row-fluid'>
            <div class=' box-quick-link blue-background'>
                  <!-- <a href='<?php echo site_url().'/tambah1/cetak/'.$detailpersonalid; ?>' target="_blank"> -->
                                    <a href='<?php echo site_url().'/upload_kpapra/uploadfile/'.$detailpersonalid; ?>'>
                    <div class='header'>
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-1" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_kpapra/hapus_data_kpapra'); ?>">

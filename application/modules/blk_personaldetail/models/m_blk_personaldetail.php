...
AND personalblk.nodaftar NOT LIKE 'JP%') ORDER BY personalblk.id_personalblk DESC";
 ...
 $kode_desa="";
        $result = Dbs::load("SELECT tgl_pengajuan FROM blk_detail_formulir
...
WHERE blk_detail_formulir.nodaftar='$nodaftar' ORDER BY blk_formulir.id_formulir DESC LIMIT 1");
	...
	function ujk_keluar($nodaftar){
		 ...
		 $kode_desa="";
        $result = Dbs::load("SELECT tgl_keluar FROM blk_detail_formulir
LEFT JOIN blk_formulir
ON blk_detail_formulir.id_formulir=blk_formulir.id_formulir
LEFT JOIN blk_pengajuan_ujk
ON blk_detail_formulir.id_formulir=blk_pengajuan_ujk.id_formulirnya
...
WHERE blk_detail_formulir.nodaftar='$nodaftar' ORDER BY blk_formulir.id_formulir DESC LIMIT 1");
		...
		function ujk_ujian($nodaftar){
					 ...
					 $kode_desa="";
        $result = Dbs::load("SELECT tgl_ujk FROM blk_detail_formulir
LEFT JOIN blk_formulir
ON blk_detail_formulir.id_formulir=blk_formulir.id_formulir
LEFT JOIN blk_pengajuan_ujk
ON blk_detail_formulir.id_formulir=blk_pengajuan_ujk.id_formulirnya
...
WHERE blk_detail_formulir.nodaftar='$nodaftar' ORDER BY blk_formulir.id_formulir DESC LIMIT 1");
		...
		return $kode_desa;	
			...
			function ujk_namalsp($nodaftar){
									 ...
									 $kode_desa="";
        $result = Dbs::load("SELECT nama FROM blk_detail_formulir
LEFT JOIN blk_formulir
ON blk_detail_formulir.id_formulir=blk_formulir.id_formulir
LEFT JOIN blk_pengajuan_ujk
ON blk_detail_formulir.id_formulir=blk_pengajuan_ujk.id_formulirnya
...
WHERE blk_detail_formulir.nodaftar='$nodaftar' ORDER BY blk_formulir.id_formulir DESC LIMIT 1");
		...
		return $kode_desa;	
				...
				function ujk_noserlok($nodaftar){
									 $kode_desa="";
        $result = Dbs::load("SELECT noserlok FROM blk_detail_formulir
LEFT JOIN blk_formulir
ON blk_detail_formulir.id_formulir=blk_formulir.id_formulir
LEFT JOIN blk_pengajuan_ujk
ON blk_detail_formulir.id_formulir=blk_pengajuan_ujk.id_formulirnya
...
WHERE blk_detail_formulir.nodaftar='$nodaftar' ORDER BY blk_formulir.id_formulir DESC LIMIT 1");
		...
		return $kode_desa;	
					...
					function ujk_noresibayar($nodaftar){
									 $kode_desa="";
        $result = Dbs::load("SELECT noresi FROM blk_detail_formulir
LEFT JOIN blk_formulir
ON blk_detail_formulir.id_formulir=blk_formulir.id_formulir
...
$kode_desa="";
$result = Dbs::load("SELECT noinvoice_ujk FROM blk_detail_formulir
LEFT JOIN blk_formulir
ON blk_detail_formulir.id_formulir=blk_formulir.id_formulir
...
$result = Dbs::load("SELECT * FROM personalblk WHERE nodaftar ='$nodaftar'");
 ...
 function simpan_data_kb(){
	...
	function tampil_data_piketdapur($idnya){
		$sql = "SELECT a.id, a.tglmulai, a.tglberakhir, a.pemberiannilai, a.nilai
				FROM blk_piketdapur a 
				WHERE a.nodaftar='$idnya'";
		$query = $this->db->query($sql);
		return $query->result();
	}
	
	function tampil_data_piketdapur_sore($idnya){
		$sql = "SELECT a.id, a.tglmulai, a.tglberakhir, a.pemberiannilai, a.nilai
				FROM blk_piketdapur a 
				WHERE a.nodaftar='$idnya' AND a.waktu='sore'";
		$query = $this->db->query($sql);
		return $query->result();
	}

	function tampil_data_kejadiansakit($idnya){
		$sql = "SELECT a.id, a.tglmulai, a.tglberakhir, a.sakit, a.ibuasrama, a.keterangan
				FROM blk_kejadiansakit a 
				WHERE a.nodaftar='$idnya'";
		$query = $this->db->query($sql);
		return $query->result();
	}	

	function tampil_data_konseling($idnya){
		$sql = "SELECT a.id, a.tgl, a.jammulai, a.jamberakhir, a.konselor, a.keterangan
				FROM blk_konselingkhusus a 
				WHERE a.nodaftar='$idnya'";
		$query = $this->db->query($sql);
		return $query->result();
	}	
	...
	function hitung_data_terlambat($idbio){
		$kode_desa="";
$result = Dbs::load("SELECT * FROM blk_izin_keluar WHERE nodaftar ='$idbio' Group By id_izin_keluar DESC LIMIT 1");
			while($row = mysqli_fetch_array($result)){
	...
	function hitung_data_terlambatinap($idbio){
		$kode_desa="";
$result = Dbs::load("SELECT * FROM blk_izin_inap WHERE nodaftar ='$idbio' Group By id_izin_inap DESC LIMIT 1");
			while($row = mysqli_fetch_array($result)){
                $kode_desa =$row['akm_terlambat'];
			}
		return $kode_desa;	
	...
	function simpan_data_piketdapur(){
		...
		$id_personalblk		= $this->input->post('id_personalblk');
		$pemberiannilai		= $this->input->post('pemberiannilai');
		...
		$data = array(
			...
			'nodaftar'			=> $id_personalblk,
			'pemberiannilai'	=> $pemberiannilai,
			'tempat'	=> $tempat,
			'nilai'				=> $nilai
		);	

		$this->db->insert('blk_piketdapur',$data);
	}
	...
	function update_data_piketdapur(){
		...
		$this->db->where('id', $id);
		$this->db->update('blk_piketdapur', $data);
	}
	...
	function simpan_data_konseling(){
		...
		$konselor		= $this->input->post('konselor');
		...
		$this->db->insert('blk_konselingkhusus',$data);
	}
	...
	function update_data_konseling(){
		...
		$this->db->where('id', $id);
		$this->db->update('blk_konselingkhusus', $data);
	}
	...
	function simpan_data_kejadiansakit(){
		...
		$ibuasrama		= $this->input->post('ibuasrama');
		$keterangan		= $this->input->post('keterangan');
		$id_personalblk	= $this->input->post('id_personalblk');
		...
		$this->db->insert('blk_kejadiansakit',$data);
	}
	...
	function update_data_kejadiansakit(){
		...
		$this->db->where('id', $id);
		$this->db->update('blk_kejadiansakit', $data);
	}
	...
	function hitung_data_terlambatpulang($idbio){
		$kode_desa="";
$result = Dbs::load("SELECT * FROM blk_izin_pulang WHERE nodaftar ='$idbio' Group By id_izin_pulang DESC LIMIT 1");
			while($row = mysqli_fetch_array($result)){
                $kode_desa =$row['akm_terlambat'];
			}
		return $kode_desa;	
...
,d.jabatan_tugas as jabatanadm
	...
	function tampil_data_piketdapurblk($idbio){
		return $this->db->query("SELECT * FROM blk_piketdapurblk WHERE nodaftar='$idbio'")->result();
	}

	function simpan_data_piketdapurblk(){
		$data = array(
			'nodaftar' => $this->input->post('id_personalblk'),
			'tglmulai' => $this->input->post('tglmulai'),
			'tglberakhir' => $this->input->post('tglberakhir'),
			'pemberiannilai' => $this->input->post('pemberiannilai'),
			'nilai' => $this->input->post('nilai')
		);
		$this->db->insert('blk_piketdapurblk', $data);
	}
	...
	function update_data_piketdapurblk(){
		...
		$this->db->update('blk_piketdapurblk', $data);
	}

	function hapus_data_piketdapurblk(){
		$this->db->where('id', $this->input->post('id'));
		$this->db->delete('blk_piketdapurblk');
	}

    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="col-lg-9">
                <div class="panel panel-flat">
                    ...
                    <div class="table-responsive">
                        <table class="table table-xxs" width="200px" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Tanggal Koreksi <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit5">Ubah</button> </td>
                                    <td>: <?php echo $data_personalblk->blk_adm_tglkor;?> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Sektor TKI <button type="button" class="btn btn-primary btn-xs " data-toggle="modal" data-target="#edit4">Ubah</button> </td>
                                    <td>: <?php echo $data_personalblk->nama_sektor_tki;?> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <?php 
                                        $ambil_ranjang = $this->M_session->select_row("SELECT 
                                                                                        b.*,a.tanggal_mulai
                                                                                        FROM blk_no_ranjang_history a
                                                                                        JOIN blk_no_ranjang b
                                                                                        ON a.ranjangno=b.id_no_ranjang 
                                                                                        WHERE a.nodaftar='$idbio' 
                                                                                        ORDER BY a.tanggal_mulai DESC");
                                        if ($ambil_ranjang != NULL) {
                                            $ambil_pamakai_ranjang_terbaru = $this->M_session->select_row("SELECT * FROM blk_no_ranjang_history WHERE ranjangno='$ambil_ranjang->id_no_ranjang' ORDER BY tanggal_mulai DESC");
                                            if ($ambil_pamakai_ranjang_terbaru->nodaftar == $idbio) {
                                                $statvvv = "DIPAKAI";
                                            } else {
                                                $statvvv = "SUDAH TDK DIPAKAI";
                                            }
                                    ?>
                                            <td>: <?php echo $ambil_ranjang->tanggal_mulai.' - '."Kode Ranjang: ".$ambil_ranjang->kode_no_ranjang." - Lokasi: ".$ambil_ranjang->lokasi." - Ranjang: ".$ambil_ranjang->ranjang;?> (<?php echo $statvvv ?>)</td>
                                    <?php
                                        } else {
                                    ?>
                                            <td>: KOSONG</td>
                                ...
                                <tr>
                                    <td>Tanggal Actual Selesai Durasi (60 hari) : A+60</td>
                                    <td>: <?php echo ''.$hitunganfingernodaft;?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td rowspan="2">Setting Fingerprint</td>
                                    <td>: <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/blk_personaldetail/settingfinger/1/<?php echo $data_personalblk->blk_nodaftar;?>">Hapus Data Finger (Data saja)</a></td>
                                </tr>
                                <tr>
                                    <td>: <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/blk_personaldetail/settingfinger/2/<?php echo $data_personalblk->blk_nodaftar;?>">Hapus Data Finger (Data + Rekapannya)</a></td>
                                </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group input-append date dewdate2" id="datePicker">
                                                    <input type="text" class="form-control" name="adm_tglreg" value="<?php echo $data_personalblk->blk_adm_tglreg;?>" placeholder="Select Datepicker"/>
                     ...
                     <div class="modal fade" id="edit5" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('blk_personaldetail/update_data_blk_koreksi'); ?>">
                            <div class="modal-header bg-primary">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h5 class="modal-title">UBAH Tanggal Koreksi <?php echo $data_personalblk->blk_nodaftar; ?></h5>
                            </div>
                           <div class="modal-body">
                              <input type="hidden" class="form-control" name="id_personalblk" value="<?php echo $data_personalblk->blk_nodaftar; ?>">
                            <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group input-append date dewdate2" id="datePicker">
                                                    <input type="text" class="form-control" name="adm_tglkor" value="<?php echo $data_personalblk->blk_adm_tglkor;?>" placeholder="Select Datepicker"/>
                                                    <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                                </div>
                                            </div>
                    ...
                    <div class="modal fade" id="edit4" tabindex="-2" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form class="form-horizontal" method="post" action="<?php echo site_url('blk_personaldetail/update_data_sektor_tki'); ?>">
                                    <div class="modal-header bg-primary">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h5 class="modal-title">Ubah Sektor TKI <?php echo $data_personalblk->blk_nodaftar; ?></h5>
                                    </div>
                                    <div class="modal-body">
                                        <input type="hidden" class="form-control" name="id_personalblk" value="<?php echo $data_personalblk->blk_nodaftar; ?>">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label>Pilih Sektor TKI</label>
                                                    <select class="select-search" name="sektor_tki">
                                                        <option value=""></option>
                                                        <?php  
                                                            foreach ($tampil_data_sektor_tki as $pilihan) {
                                                                $selecttt = ""; 
                                                                if ($sektor_tki == $pilihan->id_sektor_tki) {
                                                                    $selecttt = 'selected="selected"';
                                                                }
                                                        ?>
                                                            <option value="<?php echo $pilihan->id_sektor_tki;?>" <?php echo $selecttt; ?>><?php echo $pilihan->nama_sektor;?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="input-group input-append date dewdate2" id="datePicker">
                                                        <input type="text" class="form-control" name="tglangk" value="<?php echo $xtglawal;?>" placeholder="Select Datepicker"/>
                                                        <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form class="form-horizontal" method="post" action="<?php echo site_url('blk_personaldetail/update_data_statterbang'); ?>">
                                    <div class="modal-header bg-primary">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h5 class="modal-title">UBAH DATA TERBANG NON TAIWAN <?php echo $data_personalblk->blk_nodaftar; ?></h5>
                                    </div>
                                    <div class="modal-body">
                                        <input type="hidden" class="form-control" name="id_personalblk" value="<?php echo $data_personalblk->blk_nodaftar; ?>">
                                        <div class="form-group">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" class="form-control" name="id_personalblk" value="<?php echo $data_personalblk->blk_nodaftar; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label>Tanggal Cek FIsik</label>
                                                            <?php 
                                                            if ($ubah_tipe == 'FI' || $ubah_tipe == 'FF' || $ubah_tipe == 'MF' || $ubah_tipe == 'MI' || $ubah_tipe == 'JP') {
                                                                if ($data_personalblk->blk_cektgl != NULL) {
                                                                    $wwtgl = $data_personalblk->blk_cektgl;
                                                                } else {
                                                                    $rawtgl = $data_personal->personal_tgldaftar;
                                                                    $wwtgl  = str_replace(".","-",$rawtgl);
                                                                }
                                                            ?>
                                                        <div class="">
                                                            <input type="hidden" class="form-control" name="cektgl" value="<?php echo $wwtgl ?>"/>
                                                            <input type="text" class="form-control" value="<?php echo $wwtgl ?>" disabled="disabled"/>
                                                        </div>
                                                            <?php } else { ?>

                                                                    <div class="input-group input-append date dewdate2" id="datePicker">
                                                                        <input type="text" class="form-control" placeholder="Select Datepicker" name="cektgl" value="<?php echo $data_personalblk->blk_cektgl; ?>"/>
                                                                        <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                                                    </div>
                                                            <?php } ?>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <?php 
                                                            if ($data_personalblk->blk_cekket == "TIDAK ADA KELUHAN") {
                                                                $vell = 'selected="selected"';
                                                                $hell = '';
                                                            } elseif ($data_personalblk->blk_cekket == NULL) {
                                                                $vell = 'selected="selected"';
                                                                $hell = '';
                                                            } else {
                                                                $hell = 'selected="selected"';
                                                                $vell = '';
                                                            }
                                                        ?>
                                                        <select class="select-results-color" id="zcekfisik" onChange="dcekfisik()" name="cekket">
                                                            <option value="TIDAK ADA KELUHAN" <?php echo $vell ?>>Tidak Ada Keluhan</option>
                                                            <option value="etc" <?php echo $hell ?>>Lainya</option>
                                                        </select> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <input type="text" id="etc_column" name="cekket2" placeholder="KETERANGAN" class="form-control" value="<?php echo $data_personalblk->blk_cekket;?>">
                                                    </div>
                                                </div>
                                            </div>
                       ...
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('blk_personaldetail/update_data_blk_ranjang'); ?>">
                            <div class="modal-header bg-primary">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h5 class="modal-title">UBAH Tanggal Terima Ranjang <?php echo $data_personalblk->blk_nodaftar; ?></h5>
                            </div>
                           <div class="modal-body">
                              <input type="hidden" class="form-control" name="id_personalblk" value="<?php echo $data_personalblk->blk_nodaftar; ?>">
                            <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group input-append date dewdate2" id="datePicker">
                                                    <input type="text" class="form-control" name="ranjangtgl" value="<?php echo $data_personalblk->ranjang_tgl;?>" placeholder="Select Datepicker"/>
                                                    <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="select-results-color ed4" name="sponsor" id="">
                                                        <option value=""></option>
                                                        <?php  
                                                        foreach ($tampil_data_sponsor as $pilihan) { 
                                                            $sev = '';
                                                            if ($pilihan->kode_sponsor == $data_personalblk->hk_sponsor) {
                                                                $sev = 'selected="selected"';
                                                            }
                                                        ?>
                                                        <option value="<?php echo $pilihan->kode_sponsor;?>" <?php echo $sev ?>/><?php echo $pilihan->kode_sponsor." - ".$pilihan->nama;?>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="notki" value="<?php echo $data_personalblk->blk_nodaftar;?>" placeholder="EX: 0001 (NO ID TIDAK BOLEH SAMA)" class="form-control" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="file" name="hkfoto" class="file-styled">
                                                </div>-->
        ...
        <div class="panel panel-flat ">
                    ...
                    <table class="table datatable-basic table-bordered table-striped table-hover" id="table2">
                        <thead>
                            <tr>
                                <th>NO </th>
                                <th>TANGGAL</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    foreach ($tampil_hasilpkl as $row) { 
                                                        ...
                                                        ?>
                                                        <tr>
                                                          <td>  <a href="<?php echo site_url('blk_personaldetail/cetak_pkl/'.$row->id_pkl); ?>" class="btn btn-danger btn-sm"><i class="icon-printer2"></i>PRINT</a> </td>
...
<script type="text/javascript" charset="utf-16">
    ...
    function dcekfisik() {
        var x = document.getElementById("zcekfisik").value;
        if ( x ==  "etc" ) {
            $("#etc_column").show();
        } else {
            $("#etc_column").hide();

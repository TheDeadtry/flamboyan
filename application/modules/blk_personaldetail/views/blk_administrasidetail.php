                            ...
                            <div class="panel-group" id="accordion-styled">
                                ...
                                <div class="panel">
                                    <div class="panel-heading bg-success">
                                        <h6 class="panel-title">
                                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion-styled" href="#accordion-styled-group11">PIKET DAPUR</a>
                                        </h6>
                                    </div>
                                    <div id="accordion-styled-group11" class="panel-collapse collapse">
                                        <?php 
                                            $this->load->view('blk_personaldetail/blk_piketdapur');
                                        ?>
                                    </div>
                                </div>
                                  <div class="panel">
                                      <div class="panel-heading bg-success">
                                          <h6 class="panel-title">
                                              <a class="collapsed" data-toggle="collapse" data-parent="#accordion-styled" href="#accordion-styled-group8">GRAHA PAGI/SORE</a>
                                          </h6>
                                      </div>
                                      <div id="accordion-styled-group8" class="panel-collapse collapse <?php echo $kej; ?>">
                                          <?php 
                                              $this->load->view('blk_personaldetail/blk_nilai');
                                          ?>
                                      </div>
                                  </div>
                                  ...
                                  <div class="panel">
                                      <div class="panel-heading bg-info">
                                          <h6 class="panel-title">
                                              <a class="collapsed" data-toggle="collapse" data-parent="#accordion-styled" href="#accordion-styled-group9">DATA KEJADIAN SAKIT SELAMA PELATIHAN</a>
                                          </h6>
                                      </div>
                                      <div id="accordion-styled-group9" class="panel-collapse collapse <?php echo $kej; ?>">
                                          <?php 
                                              $this->load->view('blk_personaldetail/blk_sakit');
                                          ?>
                                      </div>
                                  </div>
                                  ...
                                  <div class="panel">
                                      <div class="panel-heading bg-danger">
                                          <h6 class="panel-title">
                                              <a class="collapsed" data-toggle="collapse" data-parent="#accordion-styled" href="#accordion-styled-group10">DATA KONSELING KHUSUS SELAMA PELATIHAN</a>
                                          </h6>
                                      </div>
                                      <div id="accordion-styled-group10" class="panel-collapse collapse <?php echo $kej; ?>">
                                          <?php 
                                              $this->load->view('blk_personaldetail/blk_konseling');
                                          ?>
                                      </div>
                                  </div>

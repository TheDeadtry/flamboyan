...
<div class="panel-body">
    ...
    <table class="table datatable-basic table-bordered table-striped table-hover" id="table1">
        <thead>
            <tr class="active">
                <th colspan="6">
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_form_horizontal_nilai_sore">TAMBAH DATA GRAHA SORE</button>
                    <div id="modal_form_horizontal_nilai_sore" class="modal fade">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h5 class="modal-title">Tambah Graha Sore [<?php echo $idbio; ?>]</h5>
                                </div>
                                <form action="<?php echo site_url('blk_personaldetail/simpan_data_piketdapur'); ?>" class="form-horizontal" method="post">
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="waktu" value="sore" />
        ...
        <tbody>
            <?php 
                $no = 1;
                foreach ($tampil_data_piketdapur_sore as $row) { 
            ?>
                    <tr>
                        <td><?php echo $no;?></td>
                        <td class="text-center">
                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editnilaisore<?php echo $no; ?>"><i class="icon-pencil"></i> </button> 
                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusnilaisore<?php echo $no; ?>"><i class="glyphicon glyphicon-trash"></i></button> 
                        </td>
                    ...
                    <div id="editnilaisore<?php echo $no; ?>" class="modal fade" role="dialog">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header bg-warning">
                                    <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h5 class="modal-title">Update Graha Sore [<?php echo $idbio; ?>]</h5>
                                </div>
                                <div class="modal-body">
                    ...
                    <div id="hapusnilaisore<?php echo $no; ?>" class="modal fade" role="dialog">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header bg-danger">
                                    <button type="button" class="close" data-dismiss="modal">×</button>
                                    <h5 class="modal-title">Hapus Graha Sore [<?php echo $idbio; ?>]</h5>
                                </div>

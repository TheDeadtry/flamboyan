...
class M_databio extends CI_Model{
    ...
    function delete_personal($id="")
    {
        ...
        if($id != ""){
            $qr ="DELETE FROM personal WHERE id_biodata = '$id'";
            $this->db->query($qr);
            redirect('databio');
        }else{
            redirect('databio');
    ...
    function tampil_pengguna_agen($id_user){
		$nama;
        $result = Dbs::load("SELECT kode_agen FROM dataagen where username='$id_user'");
    ...
    function ambiltki($where, $limit){
        $kode_desa=array();
        $query = "SELECT personal.id_biodata FROM personal 
        $where order by personal.id_personal DESC $limit  ";
        // echo($query);
        // die();
        $result = Dbs::load($query);
        while($row = mysqli_fetch_array($result)){
    ...
    function ambilnamasemua($where){
        $kode_desa=array();
        $result = Dbs::load(
            "SELECT
            personal.id_biodata,
            personal.kode_sponsor,
            personal.tanggaldaftar,
            personal.tinggi,
            personal.berat,
            personal.pendidikan,
            personal.notelp,
            ...
            FROM personal 
            left join disnaker_show disnaker
            ...
            WHERE
		personal.id_biodata IN ($where)
	GROUP BY 
		personal.id_biodata, disnaker.id_biodata, upload_kehilanganpaspor.penting, upload_kehilanganpaspor.tglterima, pasporlama.tglterbit;");
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            $kode_desa[$row['id_biodata']][]=$row['personalid'];

            $kode_desa[$row['id_biodata']][]=$row['personalnama'];
            $kode_desa[$row['id_biodata']][]=$row['kode_sponsor'];
            $kode_desa[$row['id_biodata']][]=$row['tanggaldaftar'];
            $kode_desa[$row['id_biodata']][]=$row['biotempatlahir'];
            $kode_desa[$row['id_biodata']][]=$row['biotgllahir'];
            $kode_desa[$row['id_biodata']][]=$row['tinggi'];
            $kode_desa[$row['id_biodata']][]=$row['berat'];
            $kode_desa[$row['id_biodata']][]=$row['pendidikan'];
            $kode_desa[$row['id_biodata']][]=$row['personalstatus'];
            $kode_desa[$row['id_biodata']][]=$row['notelp'];

            $kode_desa[$row['id_biodata']][]=$row['notelpkel'];
            $kode_desa[$row['id_biodata']][]=$row['bioumur']." Tahun";
            $kode_desa[$row['id_biodata']][]=$row['status'];
            $kode_desa[$row['id_biodata']][]=$row['disnakernama'];
            $kode_desa[$row['id_biodata']][]=$row['disnakertempatlahir'];
            $kode_desa[$row['id_biodata']][]=$row['disnakertgllahir'];
             $kode_desa[$row['id_biodata']][]=$row['disnakerumur']." Tahun";
             $kode_desa[$row['id_biodata']][]=$row['disnakerstatus'];
             $kode_desa[$row['id_biodata']][]=$row['disnakerperkiraan'];
             $kode_desa[$row['id_biodata']][]=$row['disnakertglonline'];

            $kode_desa[$row['id_biodata']][]=$row['keterangan'];
            $kode_desa[$row['id_biodata']][]=$row['expiredpplm'];
             $kode_desa[$row['id_biodata']][]=$isiktp;
             $kode_desa[$row['id_biodata']][]=$isikk;
             $kode_desa[$row['id_biodata']][]=$isiakte;
             $kode_desa[$row['id_biodata']][]=$isisi;
             $kode_desa[$row['id_biodata']][]=$isiskck;
             $kode_desa[$row['id_biodata']][]=$isisn;
             $kode_desa[$row['id_biodata']][]=$isiijasah;
             $kode_desa[$row['id_biodata']][]=$isipp;
             
             $kode_desa[$row['id_biodata']][]=$isiarc;
             $kode_desa[$row['id_biodata']][]=$isiket;
              $kode_desa[$row['id_biodata']][]=$row['hilangpenting'];
               $kode_desa[$row['id_biodata']][]=$row['hilangtglterima'];
               $kode_desa[$row['id_biodata']][]=$row['disnakernodisknaker'];
               $kode_desa[$row['id_biodata']][]=$row['statusaktif'];
               $kode_desa[$row['id_biodata']][]=$row['negara1'];
               $kode_desa[$row['id_biodata']][]=$row['negara2'];
               $kode_desa[$row['id_biodata']][]=$row['calling'];
               $kode_desa[$row['id_biodata']][]=$row['skill1'];
               
               $kode_desa[$row['id_biodata']][]=$row['skill2'];
               $kode_desa[$row['id_biodata']][]=$row['skill3'];
               $kode_desa[$row['id_biodata']][]=$row['ketdok'];
               $kode_desa[$row['id_biodata']][]=$row['ketadm'];
    ...
    function ambilnama($where){
     ...
     function medical($idbio){
        $result = Dbs::load("SELECT namamed, tanggal FROM medical  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
    ...
    function manual($qr=""){
        ...
        while($row = mysqli_fetch_object($result)){
            if(isset($row->id_biodata)){
                $kode_desa[$row->id_biodata] = (array) $row;
            }else{
                $kode_desa[] = $row;
            }
        }
    ...
    function namamedical($idbio){
        $kode_desa="";
        $result = Dbs::load("SELECT id_medical,jenismedical,nama as namamed,id_biodata FROM medical  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
        while($row = mysqli_fetch_array($result)){
    ...
    function namamedicaltgl($idbio){
        $kode_desa="";
        $result = Dbs::load("SELECT id_medical,jenismedical,nama as namamed,id_biodata,tanggal FROM medical  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
            while($row = mysqli_fetch_array($result)){
    ...
    function medical3($idbio){
        $result = Dbs::load("SELECT hitung, tanggal, nama, expired, tglsidik FROM medical3  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
        $row = mysqli_fetch_array($result);
        return $row;
    }
    ...
    $kode_desa="";
 $result = Dbs::load("SELECT * FROM medical3  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
            while($row = mysqli_fetch_array($result)){
                $kode_desa=$row['tanggal'];
            }
        return $kode_desa;
 ...
 $result = Dbs::load("SELECT * FROM medical3  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
    ...
    $kode_desa="";
 $result = Dbs::load("SELECT *,tanggal + INTERVAL '3' MONTH as expired FROM medical3  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
            while($row = mysqli_fetch_array($result)){
 ...
 $result = Dbs::load("SELECT * FROM medical3  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
        ...
        function medical2($idbio){
            $result = Dbs::load("SELECT tanggal, nama, expired, tglsidik FROM medical2  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
            $row = mysqli_fetch_array($result);
            return $row;
        }
    ...
    $kode_desa="";
 $result = Dbs::load("SELECT * FROM medical2  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
            while($row = mysqli_fetch_array($result)){
                $kode_desa=$row['tanggal'];
            }
        return $kode_desa;
 ...
 $result = Dbs::load("SELECT * FROM medical2  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
    ...
    $kode_desa="";
 $result = Dbs::load("SELECT *,tanggal + INTERVAL '3' MONTH as expired FROM medical2  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
            while($row = mysqli_fetch_array($result)){
                $kode_desa=$row['expired'];
            }
        return $kode_desa;
 ...
 $result = Dbs::load("SELECT * FROM medical2  where id_biodata='$idbio' order by id_medical ASC LIMIT 1 ");
    ...
    function hitungmed($idbio){
        $kode_desa="";
        $result = Dbs::load("SELECT count(*) as hitung FROM medical3 where id_biodata='$idbio'");
        while($row = mysqli_fetch_array($result)){
    ...
    function personalblk($idbio){
        $result = Dbs::load("SELECT * FROM personalblk where nodaftar='$idbio' LIMIT 1");
        $row = mysqli_fetch_array($result);
        return $row;
    }
    ...
    function tglregblk($idbio){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM personalblk where nodaftar='$idbio'");
        while($row = mysqli_fetch_array($result)){
    ...
    function hitunganfingernodaftujuh($idbio){
       ...
       function hitunganfingernodaft($idbio){
        $kode_desa="";
        $result = Dbs::load("SELECT DATE_ADD(adm_tglreg, INTERVAL 40 DAY) as expired FROM personalblk WHERE nodaftar='$idbio'");
                 while($row = mysqli_fetch_array($result)){
                $kode_desa=$row['expired'];
            }
        return $kode_desa;
    ...
    function kelulusan($nodaftar){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM personalblk WHERE nodaftar ='$nodaftar'");
        while($row = mysqli_fetch_array($result)){
    ...
    function tglterakhirfinger($nodaftars){
        $kode_desa="";
        $result =  Dbs::load("SELECT dteDate FROM tblattendance WHERE idblk='".$nodaftars."' Group by dteDate DESC LIMIT 1");
            while($row = mysqli_fetch_array($result)){
    ...
    function namadisnaker($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM disnaker where id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
            $kode_desa=$row['nama'];
        }
        return $kode_desa;
    ...
    //paspor Baru
    function paspor($id_biodata){
        $result = Dbs::load("SELECT * FROM paspor where id_biodata='$id_biodata' ORDER BY id_paspor DESC limit 1");
        $row = mysqli_fetch_array($result);
        return $row;
    }
   ...
   function ajustatpaspor($id_biodata){
    ...
    function expiredpaspor($idnya){
        $kode_desa="";
        $result = Dbs::load("SELECT *,DATE_ADD(tglterbit, INTERVAL 5 YEAR) as expired FROM paspor WHERE id_biodata='".$idnya."'");
        while($row = mysqli_fetch_array($result)){
            $kode_desa=$row['expired'];
        }
        return $kode_desa;
  ...
  // SKCK
    ...
    function skck($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM skck where id_biodata='$id_biodata'");
        $row = mysqli_fetch_array($result);
        return $row;
    } 
    ...
    //agen
     ...
     function tglmajikan($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM majikan where id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
    ...
    function kodeagen($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT *,dataagen.kode_agen as kodeagennya FROM majikan LEFT JOIN dataagen ON majikan.kode_agen=dataagen.id_agen where majikan.id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
 ...
 // data agen dan terbang
    ...
    function kodemajikanformal($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT *,datamajikan.kode_majikan as kodemajikannya FROM majikan LEFT JOIN datamajikan ON majikan.kode_majikan=datamajikan.id_majikan where majikan.id_biodata='$id_biodata'");
            while($row = mysqli_fetch_array($result)){
   ...
   function kodemajikaninformal($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM majikan where majikan.id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
    ...
    function jadwal($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM visa where id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
   ...
   function keberangkatan($idjadwal){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM dataterbang where id_terbang='$idjadwal'");
        while($row = mysqli_fetch_array($result)){
    ...
    function tglterimasuhan($id_suhan){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM datasuhan where id_suhan='$id_suhan'");
        while($row = mysqli_fetch_array($result)){
            $kode_desa=$row['tglterima'];
        }
        return $kode_desa;
    ...
    function tglterimavisapermit($id_suhan){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM datavisapermit where id_visapermit='$id_suhan'");
        while($row = mysqli_fetch_array($result)){
   ...
   function ambillegalitas($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM legalitas where id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
   ...
   function ambilnotarisan($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM notarisan where id_biodata='$id_biodata'");
            while($row = mysqli_fetch_array($result)){
   ...
   function ambilrekomskck($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT * FROM pembuatan_skck where id_tki='$id_biodata'");
            while($row = mysqli_fetch_array($result)){
                $kode_desa=$row['nomor'];
            }
        return $kode_desa;
   ...
   function ambilrekomskck2($id_biodata){
    ...
    function asuransipra($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT *,pembuatan_tabeldis2.tanggal as tanggalnya FROM pembuatan_tabeldis2 LEFT JOIN detail_tabeldis2 ON detail_tabeldis2.id_tabeldis2=pembuatan_tabeldis2.id_pembuatan where detail_tabeldis2.id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
     ...
     function asuransimasa($id_biodata){
        $kode_desa="";
        $result = Dbs::load("SELECT *,pembuatan_tabeldis3.tanggal as tanggalnya FROM pembuatan_tabeldis3 LEFT JOIN detail_tabeldis3 ON detail_tabeldis3.id_tabeldis3=pembuatan_tabeldis3.id_pembuatan where detail_tabeldis3.id_biodata='$id_biodata'");
        while($row = mysqli_fetch_array($result)){
            $kode_desa=$row['tanggalnya'];
        }
        return $kode_desa;
...
// terima
   ...
   function signingbank($id_biodata){
        $result = Dbs::load("SELECT * FROM signingbank where id_biodata='$id_biodata'");
        $row = mysqli_fetch_array($result);
        return $row;
    }
...
//telo
    ...
    function majikan($id_biodata){
        $result = Dbs::load("SELECT kode_majikan, kode_agen, tglterpilih, tglpk, namamajikan, kode_suhan, tglterimasuhan, id_suhan, kode_visapermit, tglterimapermit, id_visapermit, bandaratuju FROM majikan where id_biodata='$id_biodata'");
        $row = mysqli_fetch_array($result);
        return $row;
    } 
    
    function datamajikan($id_biodata){
        $result = Dbs::load("SELECT * FROM datamajikan where id_majikan='$id_biodata'");
        $row = mysqli_fetch_array($result);
        return $row;
    } 
    
    function dataagen($id_biodata){
        $result = Dbs::load("SELECT * FROM dataagen where id_agen='$id_biodata'");
        $row = mysqli_fetch_array($result);
        return $row;
    } 

                                ...
                                <table class="table table-xxs table-bordered table-striped table-hover" id="dkrh">
                                    <thead>
                                        <tr>
                                            ...
                                            <td max-width="100%" style="text-align:center">NILAI <br/>PSIKOTEST</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                        ...
                                                        <table class="table table-xxs table-bordered table-striped table-hover" id="dkrh2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <td max-width="100%" style="width: 300px;text-align:center">NILAI</td>
                                                                    <td max-width="100%" style="text-align:center">NILAI IQ</td>
                                                                </tr>
                                                            </thead>
                                                            <tbody>

 ...
 <?php } ?>
    ...
    <div class='span8 box box-transparent'>
        <div class='row-fluid'>
             ...
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_spik'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Pernyataan Ijin Keluarga</div>
                </a>
            </div>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_legal'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Pernyataan Legalitas</div>
                </a>
            </div>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_waris'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Pernyataan Keterangan Ahli Waris</div>
                </a>
            </div>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_sikb'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Ijin Keluarga Banyuwangi</div>
                </a>
            </div>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_spaw'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat pernyataan Ahli Waris</div>
                </a>
            </div>
    ...
    <div class='span8 box box-transparent'>
        <div class='row-fluid'>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_sppf'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Perjanjian/Pernyataan Formal</div>
                </a>
            </div>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_ppi'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Perjanjian/Pernyataan Informal</div>
                </a>
            </div>
             <div class='span2 box-quick-link muted-background'>
                <a href='<?php echo site_url().'/upload_sppppj'; ?>'>
                    <div class='header'>
                        <div class='icon-tags'></div>
                    </div>
                    <div class='content'>Surat Perjanjian/Pernyataan Panti Panti Jompo</div>
                </a>
            </div>

...
$ambil_data_propinsi_tipe = $disnaker ? ($disnaker->propinsi ? $disnaker->propinsi : null) : null;

$kp = $this->db->query("SELECT nama FROM kriteria_pekerjaan GROUP BY nama ORDER BY kode ASC")->result();
?>
<?php 
$nilai_pekerjaan = [];
$nilai_pekerjaan_kode = [];
$query_result = $this->db->query("SELECT 
        a.kode
        , a.nama
        , concat('(',b.point,') ',b.keterangan) as keterangan
    FROM majikan_kriteria_pekerjaan a
    LEFT JOIN kriteria_pekerjaan b ON a.kode = b.kode 
    WHERE a.id_biodata = '$detailpersonalid'")
    ->result();

foreach ($query_result as $rowpekerjaan) {
    if(!isset($nilai_pekerjaan[$rowpekerjaan->nama])){
        $nilai_pekerjaan[$rowpekerjaan->nama] = [];
    }
    if(!isset($nilai_pekerjaan_kode[$rowpekerjaan->nama])){
        $nilai_pekerjaan_kode[$rowpekerjaan->nama] = [];
    }
    $nilai_pekerjaan[$rowpekerjaan->nama][] = $rowpekerjaan->keterangan;
    $nilai_pekerjaan_kode[$rowpekerjaan->nama][] = $rowpekerjaan->kode;
}
?>

<script src="https://app.flamboyangemajasa.com/flamboyan/assets/pdfmake.js"></script>
<style type="text/css">
    #satu {
        display: block;
        width: 95%;
...
<div class="row-fluid">
        ...
        <div class='box-content box-no-padding'>
            ...
            <div class="span6">
                ...
                <h4><?php echo $row->nama;?>
                    <br /><small><?php echo "".$detailpersonalid."".$row->negara1."".$row->negara2."".$row->calling."".$row->skill1."".$row->skill2."".$row->skill3; ?></small>
                </h4>
                <?php else : ?>
                <h4><?php echo $row->nama;?>
                    <br /><small><?php echo "".$detailpersonalid."".$row->negara1."".$row->negara2."".$row->calling."-".$row->skill1."".$row->skill2."".$row->skill3; ?></small>
                ...
                <div class="alert alert-info ">
                    ...
                    <a href="<?php echo site_url('detailmajikan/vubahmajikan/'.$detailpersonalid); ?>"
                        class="btn btn-info btn-medium"></i>Edit Grup Majikan</a>
                    <?php else : ?>
                    <a class='btn btn-info btn-medium modal-aksi' target="modal-formal-edit">Ubah Data</a>
                    <a href="<?php echo site_url('detailmajikan/vubahmajikanformal/'.$detailpersonalid); ?>"
                        class="btn btn-info btn-medium"></i>Edit Grup Majikan</a>
                    <?php endif; ?>
                    <a href="<?php echo site_url('detailmajikan/aturulangform/'.$detailpersonalid); ?>"
                        class="btn btn-info btn-medium"></i>Form Atur Ulang</a>
                </div>
                <?php endif; ?>
                <?php if($stts == 'FI' || $stts == 'MI' || $stts == 'IM') : ?>
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            <td class="span3"> Pekerjaan :</td>
                            <td> <?php echo $row->pekerjaan;?> </td>
                        </tr>
                        <tr>
                            <td class="span3"> Marketing :</td>
                    ...
                    $hasil3 = $row->statustglterbang; ?>
                        ...
                        <tr>
                            <td class="span3">Rangkuman Pekerjaan</td>
                            <td></td>
                        </tr>
                        
                        <?php foreach($kp as $k) : ?>
                            <tr>
                                <td class="span3"><?= $k->nama ?> :</td>
                                <td><?= join("<br>", $nilai_pekerjaan[$k->nama]) ?></td>                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                <?php endforeach; ?>
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            <td class="span3"> Pekerjaan :</td>
                            <td> <?php echo $rowformal->pekerjaan;?> </td>
                        </tr>
                        <tr>
                            <td class="span3"> JD :</td>
                        ...
                        <?php foreach($kp as $k) : ?>
                            <tr>
                                <td class="span3"><?= $k->nama ?> :</td>
                                <td><?= join("<br>", $nilai_pekerjaan[$k->nama]) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                ...
                <div class='row-fluid'>
                    <div class=' box-quick-link blue-background'>
                        <a href="#" id="pkpdf">
                            ...
                            <div class='content'>DL005. PERJANJIAN KERJA PDF</div>
                        </a>
                    </div>
                    <br>
                    <div class=' box-quick-link blue-background'>
                        <a href='<?php echo site_url().'/tambah1/cetakbaru/'.$detailpersonalid; ?>'>
                            <div class='header'>
                                <div class='icon-book'></div>
                            </div>
                    ...
                    <div class=' box-quick-link blue-background'>
                        <a
                            href="<?= site_url(); ?>/pernyataan_persetujuan_tenaga_kerja/print_apendik/<?= $detailpersonalid; ?>">
                            <div class='header'>
                                <div class='icon-book'></div>
                            </div>
                    ...
                    <div class=' box-quick-link blue-background'>
                        <a
                            href="<?= site_url(); ?>/detailmajikan/print_invoice/<?= $detailpersonalid."/".$detailpersonalid; ?>">
                            <div class='header'>
                                <div class='icon-book'></div>
                            </div>
                            <div class='content'>Invoice</div>
                        </a>
                    </div>
                    <br>

                    <?php if($stts == 'IM' || $stts == 'FI' || $stts == 'MI' || $stts == "MC" || $stts == "MH" || $stts == "HK" || $stts == "FH") { ?>
                    <?php if ($ambil_data_propinsi_tipe != "") { ?>
                    <div class=' box-quick-link blue-background'>
                        <a href="<?= site_url(); ?>/detailmajikan_spbg/print_spbg/<?= $detailpersonalid; ?>">
                            <div class='header'>
                                <div class='icon-book'></div>
                            </div>
    ...
    <div id="modal-formal" class="modal-gugus modal-lain">
        <div class="modal-pages">
            <div class="card">
                ...
                <form action="<?php echo site_url('detailmajikan/tambahmajikan');?>" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="group" class="form-control" id="group">
                                ...
                                <?php if(explode("-", $detailpersonalid)[0] === "IM") : ?>
                                <option value="IM">Malaysia</option>
                                <?php else :?>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="terpilih"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="namamajikan" class=" popovers" value="" data-trigger="hover"
                                data-content="" data-original-title="namamajikan" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label "> Nama Majikan (taiwan)</label>
                        <div class="controls">
                            <input type="text" name="namataiwan" class=" popovers" value="" data-trigger="hover"
                                data-content="" data-original-title="namamajikan" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="bandaratuju" class=" popovers" value="" data-trigger="hover"
                                data-content="" data-original-title="bandaratuju" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label "> No Telp Majikan</label>
                        <div class="controls">
                            <input type="text" name="notelpmajikan" class=" popovers" data-trigger="hover"
                                data-content="" data-original-title="namamajikan" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="alamatmajikan" class=" popovers" data-trigger="hover"
                                data-content="" data-original-title="namamajikan" />
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="tglterbitsuhan"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea rows="10" type="text" name="pekerjaan" class=" popovers" data-trigger="hover"
                                data-content="" data-original-title="Pekerjaan"></textarea>
                        </div>
                    </div>
                    <h5>Rangkuman Pekerjaan</h5>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <?php
                                $nama = $row->nama;
                                $list = $this->db->query("SELECT * FROM kriteria_pekerjaan WHERE nama = '$nama'")->result();
                            ?>
                            <select name="pekerjaanlist[<?php echo $nama; ?>][]" class="sl2 form-control" multiple="multiple" style="width: 100%;">
                                <?php foreach($list as $rows): ?>
                                    <option value="<?php echo $rows->kode;?>">(<?php echo $rows->point;?>) <?php echo $rows->keterangan;?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="marketing" class=" popovers" data-trigger="hover" data-content=""
                                data-original-title="Marketing" />
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="tglterimasuhan"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="ketsuhan" class=" popovers" data-trigger="hover" data-content=""
                                data-original-title="Visa Permit" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="visapermit" class=" popovers" data-trigger="hover" data-content=""
                                data-original-title="Visa Permit" />
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="tglpk"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="tgltrmspbg"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="jd"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <input class='input-medium' data-format='yyyy.MM.dd' name="terbang"
                                placeholder='Select datepicker' type='text' />
                        </div>
                    </div>
    ...
    <div id="modal-formal-edit" class="modal-gugus modal-lain">
        <div class="modal-pages">
            <div class="card">
                ...
                <form action="<?php echo site_url('detailmajikan/ubahmajikan');?>" enctype="multipart/form-data"
                    method="post" class="form-horizontal" />
                <?php foreach ($tampil_data_majikanformal as $rowformal) : ?>
                <div class="card-body">
                    <br><br>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="group" class="form-control" id="group">
                                ...
                                <option selected="selected" value="<?= $datagroup->id_group ?>"><?= $datagroup->nama; ?>
                                </option>
                                <?php else : ?>
                                <option value="<?= $datagroup->id_group ?>"><?= $datagroup->nama; ?></option>
                                <?php endif;?>
                    ...
                    <div class="control-group" id="jelasin_agen">
                        ...
                        <div class="controls">
                            <select class="form-control" name="kodeagen" id="kodeagen">
                                ...
                                <option selected="selected" value="<?= $dataagen->id_agen ?>"><?= $dataagen->nama; ?>
                                </option>
                                <?php else : ?>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd'
                                    value="<?php echo  $rowformal->tglpk;?>" name="tglpk"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd'
                                    value="<?php echo  $rowformal->tgltrmspbg;?>" name="tgltrmspbg"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group">
                        <label class="control-label "> Nama Majikan </label>
                        <div class="controls">
                            <input type="text" name="namamajikan" class=" popovers"
                                value="<?= $namamajikan_informal; ?>" data-trigger="hover" data-content=""
                                data-original-title="namamajikan" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label "> Nama Majikan (taiwan)</label>
                        <div class="controls">
                            <input type="text" name="namataiwan" class=" popovers"
                                value="<?php echo  $rowformal->namataiwan;?>" data-trigger="hover" data-content=""
                                data-original-title="namamajikan" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label "> Bandara Tujuan</label>
                        <div class="controls">
                            <input type="text" name="bandaratuju" class=" popovers"
                                value="<?php echo  $rowformal->bandaratuju;?>" data-trigger="hover" data-content=""
                                data-original-title="bandaratuju" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label "> No Telp Majikan</label>
                        <div class="controls">
                            <input type="text" name="notelpmajikan" class=" popovers"
                                value="<?php echo  $rowformal->notelpmajikan;?>" data-trigger="hover" data-content=""
                                data-original-title="namamajikan" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label "> Alamat Majikan</label>
                        <div class="controls">
                            <input type="text" name="alamatmajikan" class=" popovers"
                                value="<?php echo  $rowformal->alamatmajikan;?>" data-trigger="hover" data-content=""
                                data-original-title="namamajikan" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="suhan" class=" popovers" value="<?php echo  $ketsuhan_informal;?>"
                                data-trigger="hover" data-content="" data-original-title="Suhan" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label "> Pekerjaan</label>
                        <div class="controls">
                            <textarea rows="10" type="text" name="pekerjaan" class=" popovers" data-trigger="hover"
                                data-content=""
                                data-original-title="Pekerjaan"><?php echo  $rowformal->pekerjaan;?></textarea>
                        </div>
                    </div>
                    <h5>Rangkuman Pekerjaan</h5>
                    <?php foreach($kp as $row): ?>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            ...
                            <select name="pekerjaanlist[<?php echo $nama; ?>][]" class="sl2 form-control" multiple="multiple" style="width: 100%;" >
                                <?php foreach($list as $rows): ?>
                                    <option value="<?php echo $rows->kode;?>" <?php echo (in_array($rows->kode, $nilai_pekerjaan_kode[$nama])) ? 'selected' : ''; ?>>(<?php echo $rows->point;?>) <?php echo $rows->keterangan;?></option>
                                <?php endforeach ?>
                            </select>                        
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="marketing" class=" popovers" data-trigger="hover" data-content=""
                                data-original-title="Marketing" value="<?php echo  $rowformal->marketing;?>" />
                        </div>
                    </div>
                    <div class="control-group" id="berlaku">
                        <label class="control-label"> Tgl Terbit Suhan </label>
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd'
                                    value="<?php echo  $rowformal->tglterbitsuhan;?>" name="tglterbitsuhan"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd'
                                    value="<?php echo  $rowformal->tglterimasuhan;?>" name="tglterimasuhan"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="ketsuhan" class=" popovers" data-trigger="hover" data-content=""
                                data-original-title="Visa Permit" value="<?php echo  $rowformal->ketsuhan;?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label "> Visa Permit </label>
                        <div class="controls">
                            <input type="text" name="visapermit" class=" popovers"
                                value="<?php echo  $rowformal->id_visapermit;?>" data-trigger="hover" data-content=""
                                data-original-title="Visa Permit" />
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd'
                                    value="<?php echo  $rowformal->tglterbitpermit;?>" name="tglterbitpermit"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd'
                                    value="<?php echo  $rowformal->tglterimapermit;?>" name="tglterimapermit"
                                    placeholder='Select datepicker' type='text' />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="ketpermit" class=" popovers" data-trigger="hover" data-content=""
                                data-original-title="Visa Permit" value="<?php echo  $rowformal->ketpermit;?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="terpilih"
                                    placeholder='Select datepicker' type='text'
                                    value="<?php echo  $rowformal->tglterpilih;?>" />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                            </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="jd"
                                    placeholder='Select datepicker' type='text' value="<?php echo  $rowformal->JD;?>" />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                            </div>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <input class='input-medium' data-format='yyyy.MM.dd' name="terbang"
                                placeholder='Select datepicker' type='text'
                                value="<?php echo  $rowformal->tglterbang;?>" />
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="control-group" id="jelasin_agen">
                        ...
                        <div class="controls">
                            <select class="form-control" name="kode_majikan" id="kode_majikan">
                                ...
                                <option selected="selected" value="<?= $datamajikan->id_majikan ?>">
                                    <?= $datamajikan->nama; ?></option>
                                <?php else : ?>
                    ...
                    <div class="control-group" id="jelasin_agen">
                        ...
                        <div class="controls">
                            <select class="form-control" name="id_suhan" id="id_suhan">
                                ...
                                <option selected="selected" value="<?= $datasuhan->id_suhan; ?>">
                                    <?= $datasuhan->no_suhan; ?></option>
                                <?php else : ?>
                    ...
                    <div class="control-group" id="jelasin_agen">
                        ...
                        <div class="controls">
                            <select class="form-control" name="id_visapermit" id="id_visapermit">
                                ...
                                <option selected="selected" value="<?= $datavisapermit->id_visapermit ?>">
                                    <?= $datavisapermit->no_visapermit; ?></option>
                                <?php else : ?>
                                <option value="<?= $datavisapermit->id_visapermit ?>">
                                    <?= $datavisapermit->no_visapermit; ?></option>
                                <?php endif;?>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="span6 " name="tglsimpansuhan" data-placeholder="Choose a Category"
                                tabindex="1">
                                <option value="" />Select...
                                <?php  foreach ($option_suhan as $pilihan) : ?>
                                <?php if ($pilihan->tgl_terima == $rowformal->tglsimpansuhan) : ?>
                                <option selected="selected" value="<?php echo $pilihan->tgl_terima;?>" />
                                <?php echo $pilihan->tgl_terima;?>
                                <?php else: ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <select class="span6 " name="statsuhan" data-placeholder="Choose a Category" tabindex="1">
                                ...
                                <option selected="selected" value="<?= $value_suhan[$i]; ?>"><?= $status_suhan[$i]; ?>
                                </option>
                                <?php else: ?>
                    ...
                    <div class="control-group" id="berlaku">
                        ...
                        <div class="controls">
                            <div class='datepicker input-append' id='datepicker'>
                                <input class='input-medium' data-format='yyyy.MM.dd' name="tglpk"
                                    placeholder='Select datepicker' type='text'
                                    value="<?php echo $rowformal->tglpk;?>" />
                                <span class='add-on'>
                                    <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                </span>
                            </div>
                ...
                <form action="">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="edodo" checked="checked" type="checkbox" class="form-control"
                                name="sudahadapk"><label for="edodo">sudah ada pk</label>
                            <?php else: ?>
                            <input id="edodo" type="checkbox" class="form-control" name="sudahadapk"><label
                                for="edodo">sudah ada pk</label>
                            <?php endif ?>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Pk</label>
                            <input type="text" id="satu" class="form-control" value="<?= $personal->tgl_pk; ?>"
                                name="tglpkketaiwan" placeholder="INPUTKAN TANGGAL PK">
                        </div>
                        <div class="form-group">
                            <label>Tanggal Terima Pk</label>
                            <input type="text" id="satu" class="form-control" value="<?= $personal->terima_pk; ?>"
                                name="tglpkditrima" placeholder="INPUTKAN TERIMA PK">
                        </div>
                    </div>
                    <div class="card-footer">
                        <input type="button" onclick="simpanpk('<?= $detailpersonalid; ?>')"
                            class="btn btn-primary pkpk" value="Simpan">
    ...
    <script src="/flamboyan/pdfpage/html2pdf.js?v=1"></script>
    <script>
        const report = '<?= $detailpersonalid ?>'
    </script>
    <script type="module" src="/flamboyan/pdfpage/report.js?v=<?= date('ymdhis'); ?>"></script>
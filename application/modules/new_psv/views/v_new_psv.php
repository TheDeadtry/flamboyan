        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        ...
                        <form id="printv2_form" action="<?php echo site_url('pdf7/cetaklaporanagen');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                            <div class="panel-body">   
                                <div class="form-group ">
                                ...
                                <!--  <div class="form-group ">
                                    <label class="control-label col-sm-3"> PILIH NOMOR SUHAN </label>
                                    <div class="col-sm-9">
                                        <select class="select-search" name="id_suhan" data-placeholder="Pilih Nomor Suhan">
                                                <option value="">Pilih NOMOR SUHAN</option>
                                                <?php  foreach ($tampil_pilihan_suhan as $pilihan2) { ?>
                                                <option value="<?php echo $pilihan2->id_suhan;?>" /><?php echo $pilihan2->no_suhan;?>
                                                <?php } ?>
                                        </select>
                                    </div>
                                </div> -->
                                <div class="form-group ">
                                    <label class="control-label col-sm-3"> STATUS SUHAN </label>
                                    <div class="col-sm-9">
                                        <select class="select-search" name="id_tempat" data-placeholder="Pilih Nomor Suhan">
                                                <option value="">PILIH STATUS SUHAN</option>
                                                <option value="SUHAN DISIMPAN DI PT FGJ">SUHAN DISIMPAN DI PT FGJ</option>
                                                <option value="SUHAN TIDAK DISIMPAN DI PT FGJ">SUHAN TIDAK DISIMPAN DI PT FGJ</option>
                                                <option value="VISA PERMIT DISIMPAN DI PT FGJ">VISA PERMIT DISIMPAN DI PT FGJ</option>
                                                <option value="VISA PERMIT TIDAK DISIMPAN DI PT FGJ">VISA PERMIT TIDAK DISIMPAN DI PT FGJ</option>

                                                <!-- <?php  foreach ($tampil_pilihan_tempatsuhan as $pilihan3) { ?>
                                                <option value="<?php echo $pilihan3->id_tempat;?>" /><?php echo $pilihan3->tempatsuhandok;?>
                                                <?php } ?> -->
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-flat"> 
                        <div class="panel-heading">
                            <h5 class="panel-title">(核准函+簽證函)循環 PGM FORMAL PER AGEN UNTUK PERHITUNGAN SUHAN DAN VISA PERMIT <br><br><b>SEMUA SUHAN<b> </h5><br/>
                                </br></br>
                            ...
                            <!-- <a href="<?php base_url() ?>../index.php/new_psv/print_laporan" class="btn btn-info">Print<i class="icon-printer position-right"></i></a> -->
                            <div class="heading-elements">
                            </div>
                        </div> 
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered" id="newpsv">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2" class="emerald bg-yyy">寄臺灣<br/>TGL TERBANG</th>
...
<script type="text/javascript">
    $('#newpsv').dataTable({
        ...
        serverSide: true,
        ajax: {
            "url"       : "<?php echo site_url('new_psv/show_data_psv') ?>",
            "type"      : "POST"
        },
        columnDefs: [
            {

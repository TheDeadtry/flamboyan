        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload KPA </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
            ...
            <div class='title'>Dokumen KPA</div>
            <div class='actions'>
...
<?php if($hitungan==0){?>
               <div class="row-fluid">
                            ...
                            <div class='box-header orange-background'>
                                <div class='title'>Data UPLOAD kpa</div>
                                <div class='actions'>
                                    <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                    </a>
                                    <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <form action="<?php echo site_url('upload_kpa/simpan_data_kpa');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
...
<?php foreach ($tampil_data_kpa as $row) { ?>
                            <form action="<?php echo site_url('upload_kpa/update_data_kpa');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
<input type="hidden" class="form-control" name="id_kpa" value="<?php echo $row->id_kpa; ?>">
        ...
        <div class='row-fluid'>
            <div class=' box-quick-link blue-background'>
                  <!-- <a href='<?php echo site_url().'/tambah1/cetak/'.$detailpersonalid; ?>' target="_blank"> -->
                                    <a href='<?php echo site_url().'/upload_kpa/uploadfile/'.$detailpersonalid; ?>'>
                    <div class='header'>
...
<li>
    <div class='picture'>
        ...
        <div class='actions'>
         ...
         <a href="<?php echo base_url().'upload-kpa/'.$rows->namafile;?>"<?php echo $rows->namafile;?>>
                                                        <?php if (strpos($rows->namafile, '.doc') !== false){?>
                                                          <img width="200" src="<?php echo base_url(); ?>assets/dokmajikan/nodok.jpg"/></a> 
                                                        <?php }else{?>
                                                           <img width="200" src="<?php echo base_url(); ?>upload-kpa/<?php echo "".$rows->namafile ?>"/></a> 
                                                        <?php } ?>
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-1" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_kpa/hapus_data_kpa'); ?>">
                           <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                             <h4 class="modal-title">Hapus Data kpa</h4>
                           </div>

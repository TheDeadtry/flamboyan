    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Upload Visa Permit </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload Visa Permit  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="alert alert-info">
                        ...
                        <a class='btn btn-info btn-large' data-toggle='modal' href='#tambah' role='button'>Tambah Data</a>
                          <a class='btn btn-info btn-large' data-toggle='modal' href='<?php echo site_url().'/majikans/visapermit'; ?>' role='button'>Kembali</a>
                        </div>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header orange-background'>
                                <div class='title'>Dokumen Visa Permit</div>
                                <div class='actions'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_devisapermit as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            ...
                                            <td><?php echo $row->penting;?></td>
                                             <td><?php echo $row->cekdokumen;?></td>
                                              <td><?php echo $row->tglterima;?></td>
                                               ...
                                               <td><a class='btn btn-danger' href="<?php echo base_url().'assets/upload_devisapermit/'.$row->file;?>"><?php echo $row->file;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    ...
                    <h3>Update devisapermit</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('upload_devisapermit/update_data_devisapermit/'.$idvisapermit); ?>">
                           <div class="modal-body">
                           

                          <input type="hidden" class="form-control" name="id_devisapermit" value="<?php echo $row->id_devisapermit; ?>">
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_devisapermit/hapus_data_devisapermit/'.$idvisapermit); ?>">
                           <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                             <h4 class="modal-title">Hapus Data devisapermit</h4>
                           </div>
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id_devisapermit" value="<?php echo $row->id_devisapermit; ?>">
...
<div class='modal hide fade' id='tambah' role='dialog' tabindex='-2'>
                <div class='modal-header'>
                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                    <h3>Tambah devisapermit</h3>
                </div>
                <div class='modal-body'>
<form action="<?php echo site_url('upload_devisapermit/simpan_data_devisapermit/'.$idvisapermit);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />

<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idvisapermit ?>" class="hidden" />

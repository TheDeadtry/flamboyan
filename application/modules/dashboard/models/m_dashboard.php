...
WHERE DATE( dteDate ) BETWEEN '$date1' AND '$date2' AND blk_pemilik.id_pemilik='$idpemilik' $jk ORDER BY `usernya` ASC";
 ...
 function simpan_data_personalblk(){
	...
	function hitung_data_mf(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE id_biodata LIKE 'mf%'";
                 $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_mi(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE id_biodata LIKE 'mi%'";
                 $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_ff(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE id_biodata LIKE 'ff%'";
               $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_fi(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE id_biodata LIKE 'fi%'";
               $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_jp(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE id_biodata LIKE 'jp%'";
                $query = $this->db->query($sql)->row_array();
	...
	function hitung_data_mf_terbang(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE statterbang=1 and id_biodata LIKE 'mf%'";
                 $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_mi_terbang(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE statterbang=1 and id_biodata LIKE 'mi%'";
                 $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_ff_terbang(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE statterbang=1 and id_biodata LIKE 'ff%'";
               $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_fi_terbang(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE statterbang=1 and id_biodata LIKE 'fi%'";
               $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_jp_terbang(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE statterbang=1 and id_biodata LIKE 'jp%'";
                $query = $this->db->query($sql)->row_array();
	...
	function hitung_data_mf_md(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE (lower(statusaktif)=lower('Mengundurkan diri') || lower(statusaktif)=lower('UNFIT'))and id_biodata LIKE 'mf%'";
                 $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_mi_md(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE (lower(statusaktif)=lower('Mengundurkan diri') || lower(statusaktif)=lower('UNFIT')) and id_biodata LIKE 'mi%'";
                 $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_ff_md(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE (lower(statusaktif)=lower('Mengundurkan diri') || lower(statusaktif)=lower('UNFIT')) and id_biodata LIKE 'ff%'";
               $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_fi_md(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE (lower(statusaktif)=lower('Mengundurkan diri') || lower(statusaktif)=lower('UNFIT')) and id_biodata LIKE 'fi%'";
               $query = $this->db->query($sql)->row_array();

          return $query['total'];
	}
	 function hitung_data_jp_md(){
		$sql = "SELECT count(*) as total FROM personal_nama personal WHERE (lower(statusaktif)=lower('Mengundurkan diri') || lower(statusaktif)=lower('UNFIT')) and id_biodata LIKE 'jp%'";
                $query = $this->db->query($sql)->row_array();

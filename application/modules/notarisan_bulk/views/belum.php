                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div style="magin-bottom: 10;">
                                ...
                                <br>
                                <p><i>Klik tombol tampilkan di bawah untuk menampilkan data</i></p>
                                <p><i>Note : Cetak Data berdasarkan form sektor</i></p>
                                <button onclick="window.loaddata()" class="btn btn-primary btn-sm">Tampilkan Data</button>
...
<script type="text/javascript">
    ...
    window.cetaknotaris = function() {
        ...
        location.href =  "<?php echo site_url('notarisan_bulk/cetaknotaris') ?>/"+sektor+'/'+(date1 !=''? date1:'-')+'/'+(date2 != ''? date2 : '-')+'/'+nama;
    }

        ...
        <div class="content-wrapper">
            <div class="row">
                <div id='style-judul' class="col-lg-12">
                    <h1><i style="font-size: 20px; color: red;" class="icon-star-full2"></i> PROGRESS MARKETING INFORMAL</h1>
                    <h3 id="judul"></h3>
                </div>
                <div class="col-lg-12">
...
$("#open-modal").click(function(){
  ...
  $.ajax({
      url: "<?= site_url(); ?>/abc/dataGroupAgen",
...
$("#print-modal").click(function(){
  ...
  location.href = '<?= site_url(); ?>/abc/printData/'+nilai+'/'+nilaiDua+'/'+sesi+'/';
});
...
function jsonparse(){
  ...
  var kondisiData = getSession("kondisiData");
	...
	var Datahalaman = '';
	$.ajax({
		url: "<?= site_url(); ?>/abc/json/"+limit+"/"+search,
		method: "POST",
		dataType: "text",
    data:{

                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetak/<?php echo $row->id_tki;?>"  class="btn btn-warning">Print (Pasal 19)</a><br/>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetak/<?php echo $row->id_tki;?>/2/"  class="btn btn-warning">Print (Pasal 19) Cabang</a><br/>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetak/<?php echo $row->id_tki;?>/3/true"  class="btn btn-warning">Print (Pasal 19) Khusus Kediri</a><br/>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetak2/<?php echo $row->id_tki;?>/3/true"  class="btn btn-warning">Print (Pasal 19) Khusus Ngawi</a><br/>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetakpasal18/<?php echo $row->id_tki;?>"  class="btn btn-info">Print (Pasal 18)</a><br>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetakpasal18/<?php echo $row->id_tki;?>/2/"  class="btn btn-info">Print (Pasal 18) cabang</a><br>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/baru1/cetakpasal18/<?php echo $row->id_tki;?>/3/true"  class="btn btn-info">Print (Pasal 18) Khusus Kediri</a><br>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal/<?php echo $row->id_tki;?>/3/true"  class="btn btn-danger">Print Formal Madiun</a><br>-->
                                                <!--<a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal/<?php echo $row->id_tki;?>/3/true"  class="btn btn-danger">Print Formal 10 Pasal</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/zerocost/<?php echo $row->id_tki;?>/3/true"  class="btn btn-success">Print Zero Cost</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal_kab_pati/<?php echo $row->id_tki;?>/3/true"  class="btn btn-success">Print Formal Kab. PATI</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal_kab_banyuwangi/<?php echo $row->id_tki;?>/3/true"  class="btn btn-success">Print Formal Kab. BANYUWANGI</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal_kab_ponorogo/<?php echo $row->id_tki;?>/3/true"  class="btn btn-success">Print Formal Kab. PONOROGO</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal_kab_lampung/<?php echo $row->id_tki;?>/3/true"  class="btn btn-success">Print Formal Kab. LAMPUNG</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/formal_kab_ngawi/<?php echo $row->id_tki;?>/3/true"  class="btn btn-success">Print Formal Kab. NGAWI</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/zerocost_tulungagung_fi/<?php echo $row->id_tki;?>/3/true"  class="btn btn-info">Print Zero Cost FI Tulungagung</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/zerocost_banyuwangi/<?php echo $row->id_tki;?>/3/true"  class="btn btn-info">Print Zero Cost Banyuwangi</a><br>
                                                --><a href="<?php echo base_url(); ?>index.php/new_pdf_pp/novformal/<?php echo $row->id_tki;?>"  class="btn btn-success">Print Formal</a><br>
                                                <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/novinformal/<?php echo $row->id_tki;?>"  class="btn btn-info">Print Informal</a><br>

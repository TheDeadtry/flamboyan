    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Upload Asuransi </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload Asuransi  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
            ...
            <div class='title'>Dokumen Asuransi</div>
            <div class='actions'>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header orange-background'>
                                <div class='title'>Dokumen Ke Taiwan</div>
                                <div class='actions'>
                                    <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                    </a>
                                    <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_asuransilama as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            ...
                                            <td><?php echo $row->penting;?></td>
                                             <td><?php echo $row->cekdokumen;?></td>
                                              <td><?php echo $row->tglterima;?></td>
                                               ...
                                               <td><a class='btn btn-danger' href="<?php echo base_url().'assets/upload_asuransilama/'.$row->file;?>"><?php echo $row->file;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    ...
                    <h3>Update Asuransi</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('upload_asuransilama/update_data_asuransilama'); ?>">
                       ...
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <div class="modal-header">
                             ...
                             <h4 class="modal-title">Hapus Data Asuransi</h4>
                           </div>
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id_asuransilama" value="<?php echo $row->id_asuransilama; ?>">

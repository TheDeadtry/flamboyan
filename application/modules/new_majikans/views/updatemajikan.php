                        ...
                        <div class="panel-body">
                            <form action="<?php echo site_url('new_majikans/update_majikan');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="sektor" class="form-control " data-placeholder="Choose a Category" required tabindex="1" name="datasektor_id">
                                            <option value="">Pilih sektor</option>
                                            <?php foreach($sektor as $st) :?>
                                                <?php if($row->datasektor_id == $st->kode) : ?>
                                                    <option selected value="<?= $st->kode ?>"><?= $st->text ?></option>    
                                                        <?php else : ?>
                                                    <option value="<?= $st->kode ?>"><?= $st->text ?></option>    
                                                <?php endif ?>
                                            <?php endforeach ?>
                                        </select>
                                    </div>

                ...
                <div class='title'>Data Group</div>
                    <div class='actions'>
                        ...
                        <div class='responsive-table'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;' id="printTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th></th>
                                             ...
                                             <td>
                                                <div style='position: relative ;' class='btn-group'>
                                                    ...
                                                    <ul  style='position: relative;' class='dropdown-menu'>
                                                        <li>
                                                            <a href="#" data-toggle="modal" data-target="#edit<?php echo $no; ?>"><span>Edit</span>
                                                        </li>
                                                        <li>
                                                             <a href="#" data-toggle="modal" data-target="#hapus<?php echo $no; ?>"><span>Hapus</span></a>
                                                        </li>
	 ...
	 <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span5 " name="kodegroup" data-placeholder="Choose a Category" tabindex="1">
                                                                        ...
                                                                        <option value="<?php echo $pilihan->id_group;?>" /><?php echo $pilihan->nama;?>
                                                                         <?php
                                                                     } ?>
                                                                        </select>
                                                                        ...
                                                                        <a type="button" class='btn btn-info btn-large' href="<?php echo base_url()."index.php/agen/"?>"> Tampilkan Semua </a>
                                                                </div>
                                                            </div> 
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            ...
                            <div class='responsive-table'>
                            <div class='scrollable-area'>
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'id="printTable2">
 <thead>
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                                ...
                                                <div class='btn-group'>
                                                    ...
                                                    <ul style='position: relative;' class='dropdown-menu'>
                                                        <li>
                                                            <a href="<?php echo site_url('agen/detailagen1/'.$row->id_agen); ?>" >Tampil Agree (1)</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url('agen/detailagen2/'.$row->id_agen); ?>">Tampil Agree (2)</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url('agen/detailagen3/'.$row->id_agen); ?>">Tampil Agree (3)</a> 
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url('agen/detailagen4/'.$row->id_agen); ?>">Tampil Agree (4)</a> 
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url('agen/detailagen5/'.$row->id_agen); ?>">Tampil Agree (5)</a> 
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url('agen_tambah_tki/majikan_tki/'.$row->id_agen); ?>">Tambah Tki</a> 
                                                        </li>
                                                        <li class='divider'></li>
                                                        <li>
                                                           <a href="#" data-toggle="modal" data-target="#editagen<?php echo $no; ?>"><span>Edit</span></a> 
                                                        </li>
                                                        <li>
                                                           <a href="#" data-toggle="modal" data-target="#hapusagen<?php echo $no; ?>"><span>Hapus</span></a> 
                                                        </li>
                                                        <li class='divider'></li>
                                                         <li>
                                                           <a href="<?php echo site_url('agen/detaildokumen/'.$row->id_agen); ?>" >Permintaan Dokumen</a></a> 
                                                        </li>
                                                        <li class='divider'></li>
                                                        <li>
                                                            <a href="<?php echo site_url('new_agen_penerima_dana/index/'.$row->id_agen); ?>" >Bank</a></a> 
                                                        </li>
                                                    </ul>
                                                </div>
                                             </td>  
                                            <td>
                                                <?php if ( $row->statusnonaktif == 1 ) { ?>
                                                    <a type="button" href="<?php echo site_url('agen/changestatus/0/'.$row->id_agen) ?>" class="btn btn-danger">NON-AKTIF</a>
                                                <?php } else { ?>
                                                    <a type="button" href="<?php echo site_url('agen/changestatus/1/'.$row->id_agen) ?>" class="btn btn-success">AKTIF</a>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td><?php echo $row->nofax;?></td>
                                            <td><?php echo $row->direktur;?></td>
											<td><?php echo $row->direktur2;?></td>
                                            <td><?php echo $row->jabatan_man;?></td>
                                            <td><?php echo $row->jabatan_indo;?></td>
											...
											<td><?php echo $row->jenisagre4;?></td>
											<td><?php echo $row->jenisagre5;?></td>
                ...
                <form action="<?php echo site_url('agen/update_agen');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                          ...
                          <input type="hidden" class="form-control" name="id_agen" value="<?php echo $row->id_agen; ?>">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="direktur2" value="<?php echo $row->direktur2;?>" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="jabatan_man" value="<?php echo $row->jabatan_man;?>" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="jabatan_indo" value="<?php echo $row->jabatan_indo;?>" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span7 " name="jenisagre"  data-placeholder="Choose a Category" tabindex="1">
                                                                        ...
                                                                        <option value="formal agrikultur" />FORMAL AGRIKULTUR
                                                                        <option value="formal konstruksi" />FORMAL KONSTRUKSI
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="control-group">
                                                                <label class="control-label"> Jenis Agreement ( 4 ) </label>
                                                                </br>
                                                                <div class="controls">
                                                                    <select class="span7 " name="jenisagre4"  data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value="<?php echo $row->jenisagre4;?>" /><?php echo $row->jenisagre4;?>
                                                                         <option value=""/>
                                                                        <option value="informal caretaker" />INFORMAL CARETAKER
                                                                        <option value="formal pabrik" />FORMAL PABRIK
                                                                        <option value="formal panti" />FORMAL PANTI
...
<a class='btn btn-info btn-large' data-toggle='modal' href='#tambahgroup' role='button'>Tambah GROUP</a>
       ...
       <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="direktur2" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <label class="control-label">Jabatan Mandarin </label>
                                                            <div class="controls">
                                                                <input type="text" name="jabatan_man" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <label class="control-label">Jabatan Indonesia </label>
                                                            <div class="controls">
                                                                <input type="text" name="jabatan_indo" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="noagree2" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
															...
															<div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                        <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='dd/MM/yyyy' name="tgl_terimaagree2"  placeholder='Select datepicker' type='text' />
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="noagree3" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
															...
															<div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                        <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='dd/MM/yyyy' name="tgl_terimaagree3"  placeholder='Select datepicker' type='text' />
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>
															...
															<div class="control-group">
                                                            <label class="control-label">No Agreement ( 4 )</label>
                                                            <div class="controls">
                                                                <input type="text" name="noagree4" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>


                                                            <div class="control-group">
                                                                <label class="control-label span4"> Jenis Agreement ( 4 ) </label>
                                                                <div class="controls">
                                                                    <select class="span7 " name="jenisagre4"  data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value=" " />Pilih
                                                                        <option value="informal caretaker" />INFORMAL CARETAKER
                                                            ...
                                                            <div class="control-group">
                                                                <label class="control-label">Tanggal AGREEMENT Berlaku ( 4 )</label>
                                                                <div class="controls">
                                                                        <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='dd/MM/yyyy' name="berlaku4"  placeholder='Select datepicker' type='text' />
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>
                                                            ...
                                                            <div class="control-group">
                                                                <label class="control-label">Tanggal AGREEMENT Selesai ( 4 )</label>
                                                                <div class="controls">
                                                                        <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='dd/MM/yyyy' name="selesai4"  placeholder='Select datepicker' type='text' />
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>
															...
															<div class="control-group">
                                                                <label class="control-label">Tanggal Terima AGREEMENT ( 4 )</label>
                                                                <div class="controls">
                                                                        <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='dd/MM/yyyy' name="tgl_terimaagree4"  placeholder='Select datepicker' type='text' />
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>

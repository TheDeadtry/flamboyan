        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning panel-bordered">
                        ...
                        <?php $datanya = $this->db->query('SELECT nama FROM dataagen')->result(); ?>

                        <div class="panel-body">
                            <form class="form-inline pull-right">
                              <div class="form-group">
                                <select style="width: 250px" class="form-control" id="dapatkanAgen">
                              ...
                              <button type="button" onclick="tampilDatachange()" class="btn btn-default">Tampilkan</button>
                            </form>
            ...
            <div class="row">
                ...
                <script type="text/javascript">
                    ...
                    function tampilDatachange(){
                        var dapatkanNilai = $("#dapatkanAgen").val();
                        scrollX: true,
                        scrollY: "400px",
                        "searchable": false,
                        fixedColumns: {
                        ...
                        serverSide: true,
                        $.ajax({
                            url: "<?php echo site_url('new_majikans/show_majikan_2') ?>",
                            method: 'POST',
                            dataType: 'text',
                            data: {
                                key: "exist",

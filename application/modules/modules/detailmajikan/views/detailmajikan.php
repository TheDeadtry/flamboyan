...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
   ...
   <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="pekerjaan" class=" popovers" data-trigger="hover" data-content="" data-original-title="Pekerjaan" />
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
                                                                <label class="control-label "> Marketing</label>
                                                                <div class="controls">
                                                                    <input type="text" name="marketing" class=" popovers" data-trigger="hover" data-content="" data-original-title="Marketing" />
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
   ...
   <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label class="control-label "> Pekerjaan</label>
                                                                <div class="controls">
                                                                    <input type="text" name="pekerjaan" class=" popovers" data-trigger="hover" data-content="" data-original-title="Pekerjaan" value="<?php echo  $row->pekerjaan;?>" />
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
                                                                <label class="control-label "> Marketing</label>
                                                                <div class="controls">
                                                                    <input type="text" name="marketing" class=" popovers" data-trigger="hover" data-content="" data-original-title="Marketing" value="<?php echo  $row->marketing;?>" />
                                                                </div>
                                                            </div>

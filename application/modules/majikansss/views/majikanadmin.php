<div class='row-fluid'>
   ...
   <a href="<?php echo site_url('pdf9/cetak/'); ?>" class="btn btn-large btn-primary" type="button">Print Majikan</a>
                                <br> <br>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url().'/assets/dokmajikan/'.$row->file;?>"<?php echo $row->file;?>>
                                                ...
                                                <td>
                                           <a href="<?php echo site_url('majikans/update_data_majikan/'.$row->id_majikan); ?>" class="btn btn-mini btn-primary" type="button">Ubah</a>
                                           <a href="<?php echo site_url('majikans/ubahagens/'.$row->id_majikan); ?>"class="btn btn-mini btn-primary"></i>Edit Agen </a>

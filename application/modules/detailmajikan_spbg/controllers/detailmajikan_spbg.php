...
class detailmajikan_spbg extends MX_Controller{
...
// -------------------------------// content //--------------------------------------------------------// butuh tambahana di status pendidikan lulus atau tidak
        ...
        $spbgnilai = $this->db->query("SELECT * FROM spbg")->row();
        ...
        }else if($sektor == "FF" || $sektor == "MF" || $sektor == "JP"  || $sektor == "MH" || $sektor == "FH" || $sektor == "MC" ) {
            if ($data_majikan_agen == "PULAU JAWA") {
        ...
        }else if($sektor == "FF" || $sektor == "MF"|| $sektor == "MH"|| $sektor == "FH" || $sektor == "MC") {
        ...
        $nopaspor = $this->modalku->ambildatamod($id, "nopaspor" ,"paspor", "id_biodata" );
        if($sektor == "MH" || $sektor == "FH") {
            $document->setValue('akomodasi', number_format(0 , 0, ',', '.') );
        }else{
            $document->setValue('akomodasi', number_format(2500 , 0, ',', '.') );
        }
        ...
        $document->setValue('gaji', number_format($spbgnilai->gaji , 0, ',', '.'));
        $document->setValue('asuransitenagakerja', number_format($spbgnilai->asuransitenagakerja , 0, ',', '.'));
        $document->setValue('asuransikesehatan', number_format($spbgnilai->asuransikesehatan , 0, ',', '.'));
        $document->setValue('pajak', number_format($spbgnilai->pajak , 0, ',', '.'));

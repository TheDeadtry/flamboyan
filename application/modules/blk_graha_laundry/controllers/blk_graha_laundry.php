...
class blk_graha_laundry extends MX_Controller{
	public function __construct(){
            parent::__construct();
			$this->load->model('M_session');			
			$this->load->model('M_blk_graha_laundry');			
	}
		...
		$status = $session['session_status'];
			//user sudah login
			 if ($id_user && $status==2){
				...
				$tampil_data_blk_personaldetail = $this->M_blk_graha_laundry->tampil_data_blk_personal($pilihan);
				$data['namanya'] = $tampil_data_blk_personaldetail['namanya'];

			 	//$data['tampil_data_graha_laundry'] 	= $this->M_blk_graha_laundry->tampil_data_graha_laundry($idbio);
			 	$data['tampil_data_blk_instruktur'] = $this->M_blk_graha_laundry->tampil_data_select('blk_instruktur');
			 	$data['tampil_data_blk_nilai'] 		= $this->M_blk_graha_laundry->tampil_data_select('blk_nilai');
			 	$data['tampil_data_blk_materi'] 	= $this->M_blk_graha_laundry->tampil_data_select('blk_pelajaran_graha_laundry');
				$data['tampil_data_group'] 			= $this->M_blk_graha_laundry->tampil_group();
				$data['count_totala'] 				= $this->M_blk_graha_laundry->count_row('blk_penilaian_graha_laundry',$idbio,'nilai_a_id');
				$data['count_totalb'] 				= $this->M_blk_graha_laundry->count_row('blk_penilaian_graha_laundry',$idbio,'nilai_b_id');
				$data['t_nilaia'] 					= $this->M_blk_graha_laundry->sum_row('blk_penilaian_graha_laundry',$idbio,'nilai_a_id');
				$data['t_nilaib'] 					= $this->M_blk_graha_laundry->sum_row('blk_penilaian_graha_laundry',$idbio,'nilai_b_id');

				$data['namamodule'] = "blk_graha_laundry";
				$data['namafileview'] = "blk_graha_laundry";
	...
	function coba($idbio) {
		...
		$tampil_data_group 			= $this->M_blk_graha_laundry->tampil_group();

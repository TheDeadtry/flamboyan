...
class Kreditbank extends MX_Controller{
	...
	function simpan_data_kreditbank(){
		...
		$mandarinnya	= $this->input->post('mandarinnya');
		$statuskredit	= $this->input->post('statuskredit');
		$mandarinnya	= $this->input->post('mandarinnya2');
		$statuskredit2	= $this->input->post('statuskredit2');
		
		$this->M_kreditbank->simpan_data_kreditbank($namasektor,$nama_kredit,$jumlahkredit,$nilaikredit,$mandarinnya,$statuskredit,$mandarinnya2,$statuskredit2);

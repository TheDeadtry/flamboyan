    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Upload keterangan </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload keterangan  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
            ...
            <div class='title'>Dokumen keterangan</div>
            <div class='actions'>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_keterangan as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            ...
                                            <td><?php echo $row->penting;?></td>
                                             <td><?php echo $row->cekdokumen;?></td>
                                              <td><?php echo $row->tglterima;?></td>
                                               ...
                                               <td><a class='btn btn-danger' href="<?php echo base_url().'/assets/upload_keterangan/'.$row->file;?>"><?php echo $row->file;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url('upload_keterangan/update_data_keterangan'); ?>">
                           <div class="modal-body">
                           

                          <input type="hidden" class="form-control" name="id_keterangan" value="<?php echo $row->id_keterangan; ?>">
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_keterangan/hapus_data_keterangan'); ?>">
                           <div class="modal-header">
...
<div class='modal hide fade' id='tambah' role='dialog' tabindex='-2'>
                ...
                <div class='modal-body'>
<form action="<?php echo site_url('upload_keterangan/simpan_data_keterangan');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />

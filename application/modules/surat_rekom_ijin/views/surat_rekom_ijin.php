                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>index.php/printdata/cetak2/<?php echo $row->id_pembuatan;?>"  class="btn btn-warning">Print (DL03, DL 07)</a><br>
                                            <a href="<?php echo base_url(); ?>index.php/dl06/cetak/<?php echo $row->id_pembuatan;?>"  class="btn btn-warning">Print (DL 06)</a></td>

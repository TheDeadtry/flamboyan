...
class Pdf9 extends MX_Controller{
	...
	function cetak() {
        ...
        <html>
        <head>
            <title>PRINT DATA MAJIKAN</title>
            <style>
                @page { margin: 3mm; }
                body { margin: 3mm; }
                table {
        ...
        <body>
            <p class="text-center">PRINT DATA MAJIKAN</p>
            <br>
            <table>
                <tr>
...
$tampildata.=' 
 ...
 $no++;       
  ...
  <html>
  <head>
      <title>PRINT DATA VISAPERMIT</title>
      <script>
          function printPage() {
              window.print();
          }

        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload KK  </li>
                </ul>
            </div>
        </div>
    </div>
...
<?php if($hitungan==0){?>
               <div class="row-fluid">
                            ...
                            <div class='box-header orange-background'>
                                <div class='title'>Data UPLOAD kk</div>
                                <div class='actions'>
                                    <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                    </a>
                                    <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
...
<?php foreach ($tampil_data_kk as $row) { ?>
                            <form action="<?php echo site_url('upload_kk/update_data_kk');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
        ...
        <div class='row-fluid'>
            <div class=' box-quick-link blue-background'>
                  <!-- <a href='<?php echo site_url().'/tambah1/cetak/'.$detailpersonalid; ?>' target="_blank"> -->
                                    <a href='<?php echo site_url().'/upload_kk/uploadfile/'.$detailpersonalid; ?>'>
                    <div class='header'>
...
<li>
    <div class='picture'>
        ...
        <div class='actions'>
         ...
         <a href="<?php echo base_url().'upload-kk/'.$rows->namafile;?>"<?php echo $rows->namafile;?>>
                                                        <?php if (strpos($rows->namafile, '.doc') !== false){?>
                                                          <img width="200" src="<?php echo base_url(); ?>assets/dokmajikan/nodok.jpg"/></a> 
                                                        <?php }else{?>
                                                           <img width="200" src="<?php echo base_url(); ?>upload-kk/<?php echo "".$rows->namafile ?>"/></a> 
                                                        <?php } ?>

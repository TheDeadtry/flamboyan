...
<?php if($hitungan==0){?>
               <div class="row-fluid">
                            ...
                            <div class='box-header orange-background'>
                                <div class='title'>Data UPLOAD spaw</div>
                                <div class='actions'>
                                    <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                    </a>
                                    <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <form action="<?php echo site_url('upload_spaw/simpan_data_spaw');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
...
<?php foreach ($tampil_data_spaw as $row) { ?>
                            <form action="<?php echo site_url('upload_spaw/update_data_spaw');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
<input type="hidden" class="form-control" name="id_spaw" value="<?php echo $row->id_spaw; ?>">
        ...
        <div class='row-fluid'>
            <div class=' box-quick-link blue-background'>
                  <!-- <a href='<?php echo site_url().'/tambah1/cetak/'.$detailpersonalid; ?>' target="_blank"> -->
                                    <a href='<?php echo site_url().'/upload_spaw/uploadfile/'.$detailpersonalid; ?>'>
                    <div class='header'>
...
<li>
    <div class='picture'>
        ...
        <div class='actions'>
         ...
         <a href="<?php echo base_url().'upload-spaw/'.$rows->namafile;?>"<?php echo $rows->namafile;?>>
                                                        <?php if (strpos($rows->namafile, '.doc') !== false){?>
                                                          <img width="200" src="<?php echo base_url(); ?>assets/dokmajikan/nodok.jpg"/></a> 
                                                        <?php }else{?>
                                                           <img width="200" src="<?php echo base_url(); ?>upload-spaw/<?php echo "".$rows->namafile ?>"/></a> 
                                                        <?php } ?>
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-1" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_spaw/hapus_data_spaw'); ?>">
                           <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                             <h4 class="modal-title">Hapus Data spaw</h4>
                           </div>

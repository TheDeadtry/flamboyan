...
class m_majikans extends CI_Model
{
    ...
    public function tampil_data_majikan()
    {
        $sql = "SELECT * FROM datamajikan";
        $query = $this->db->query($sql);
        return $query->result();
    }
    public function tampil_data_majikandetail($id)
    {
    ...
    public function tampil_data_majikan2()
    {
    ...
    public function tampil_data_detail($id_majikan)
    {
    ...
    public function tampil_data_dok()
    {
    ...
    public function tampil_nama_agree1($id_majikan)
    {
        $kode_desa = "";
        $result = Dbs::load("SELECT * FROM datamajikan WHERE id_majikan='$id_majikan'");
    ...
    public function tampil_data_suhan()
    {
...
ON datagroup.id_group=datasuhan.id_group;";
    ...
    public function tampil_data_suhandata($kodemajikan)
    {
        $sql = "SELECT *,dataagen.nama as namaagen,datamajikan.nama as namamajikannya,datagroup.nama as namagroupnya
FROM datasuhan 
LEFT JOIN datamajikan 
...
ON dataagen.id_agen=datasuhan.id_agen
LEFT JOIN datagroup
ON datagroup.id_group=datasuhan.id_group WHERE datasuhan.id_majikan='$kodemajikan';";
        $tampil = $this->db->query($sql);
        return $tampil->result();
    }

    public function tampil_data_suhandetail($id)
    {
        $sql = "SELECT *,dataagen.nama as namaagen,datamajikan.nama as namamajikannya,datagroup.nama as namagroupnya
FROM datasuhan 
LEFT JOIN datamajikan 
...
;";
    ...
    public function tampil_datahistory($id)
    {
    ...
    public function tampil_datahistoryvisapermit($id)
    {
    ...
    public function ambidatasuhan($id)
    {
        $kode_desa = "";
        $result = Dbs::load("SELECT * FROM datasuhan where id_suhan='$id'");
        while ($row = mysqli_fetch_array($result)) {
    ...
    public function ambidatavisapermit($id)
    {
        $kode_desa = "";
        $result = Dbs::load("SELECT * FROM datavisapermit where id_visapermit='$id'");
        while ($row = mysqli_fetch_array($result)) {
    ...
    public function ambidatasuhanmajikan($id)
    {
        $kode_desa = "";
        $result = Dbs::load("SELECT * FROM datasuhan LEFT JOIN datamajikan ON datamajikan.id_majikan = datasuhan.id_majikan where datasuhan.id_suhan='$id'");
        while ($row = mysqli_fetch_array($result)) {
            $kode_desa = $row['nama'];
        }
        return $kode_desa;
    ...
    public function tampil_datatki($id)
    {
    ...
    public function tampil_datatkivisapermit($id)
    {
        $sql = "SELECT *,personal.id_biodata as idnyabio from majikan 
		LEFT JOIN personal ON personal.id_biodata = majikan.id_biodata 
        LEFT JOIN visa ON personal.id_biodata = visa.id_biodata
    ...
    public function tampil_data_visapermit()
    {
        $sql = "SELECT *,dataagen.nama as namaagen,datamajikan.nama as namamajikannya,datagroup.nama as namagroupnya
FROM datavisapermit 
LEFT JOIN datamajikan 
...
ON datasuhan.id_suhan=datavisapermit.id_suhan;";
    ...
    public function tampil_data_visapermitdata($idsuhan)
    {
        $sql = "SELECT *,dataagen.nama as namaagen,datamajikan.nama as namamajikannya,datagroup.nama as namagroupnya
FROM datavisapermit 
LEFT JOIN datamajikan 
...
ON datasuhan.id_suhan=datavisapermit.id_suhan WHERE datavisapermit.id_suhan='$idsuhan';";
    ...
    public function tampil_data_visapermitdetail($id)
    {
        $sql = "SELECT *,dataagen.nama as namaagen,datamajikan.nama as namamajikannya,datagroup.nama as namagroupnya
FROM datavisapermit 
LEFT JOIN datamajikan 
...
WHERE datavisapermit.id_visapermit='$id';";
    ...
    public function updatemajikans_agen()
    {
    ...
    public function updatesuhan_majikan()
    {
        $idnya = $this->input->post('idnya');
    ...
    public function updatevisapermit_majikan()
    {
        $idnya = $this->input->post('idnya');
        $group = $this->input->post('group');
        $kode_agen = $this->input->post('kode_agen');
    ...
    public function simpan_data_majikan($kode, $sektor, $nama, $hp, $email, $alamat, $status, $a, $b, $c, $d)
    {
    ...
    public function getposisiList_majikan()
    {
    ...
    public function getagenList($idgrup)
    {
    ...
    public function getposisiList_suhan()
    {
    ...
    public function ambilmajikan($kodeagen)
    {
    ...
    public function ambilsuhannya($kodeagen)
    {
    ...
    public function simpan_data_suhan()
    {
        $group = $this->input->post('group');
        $kode_agen = $this->input->post('kode_agen');
        $kodemajikan = $this->input->post('kodemajikan');
    ...
    public function simpan_data_visapermit()
    {
        $group = $this->input->post('group');
        $kode_agen = $this->input->post('kode_agen');
        $kodemajikan = $this->input->post('kodemajikan');
    ...
    public function update_data_suhan($id)
    {
        $maji = $this->input->post('majikan');
        $nosu = $this->input->post('no');
        $tgte = $this->input->post('tglterbit');
    ...
    public function update_data_visapermit($id)
    {
        $maji = $this->input->post('majikan');
        $nosuhan = $this->input->post('nosuhan');
        $nosu = $this->input->post('no');
    ...
    public function hapus_data_suhan($id)
    {
        $this->db->where('id_suhan', $id);
        $this->db->delete('datasuhan');
    }

    public function hapus_data_visapermit($id)
    {
        $this->db->where('id_visapermit', $id);
        $this->db->delete('datavisapermit');
    }

    public function ambil_id_majikan($id)
    {
    ...
    public function ambil_id_suhan($id)
    {
        $sql = "SELECT *
FROM datasuhan
...
ON datasuhan.id_majikan=datamajikan.id_majikan where id_suhan='$id';";
    ...
    public function ambil_id_visapermit($id)
    {
        return $this->db->get_where('datavisapermit', array('id_visapermit' => $id))->row();
    }

    public function update_majikan()
    {
    ...
    public function update_visapermit()
    {
    ...
    public function hapus_visapermit()
    {
        $id = $this->input->post('id_visapermit');
        $namafile = $this->input->post('file');
    ...
    public function simpan_history_suhan($id)
    {
    ...
    public function update_history_suhan()
    {
    ...
    public function hapus_history_suhan($id)
    {
        $id_suhan = $this->input->post('id_suhanhistory');
    ...
    public function simpan_history_visapermit($id)
    {
    ...
    public function update_history_visapermit()
    {
    ...
    public function hapus_history_visapermit($id)
    {
        $id_visapermit = $this->input->post('id_visapermithistory');

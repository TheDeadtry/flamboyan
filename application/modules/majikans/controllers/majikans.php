...
class Majikans extends MX_Controller
{
    ...
    public function detaildokumen($idmajikan)
    {
    ...
    public function simpandokumen($idmajikan)
    {
        $this->m_majikans->simpandokumen();
        redirect('majikans/detaildokumen/'.$idmajikan);
    }
    public function updatedokumen($idmajikan)
    {
        $this->m_majikans->updatedokumen();
        redirect('majikans/detaildokumen/'.$idmajikan);
    }

    public function hapusdokumen($idmajikan)
    {
    ...
    public function tampilsuhan($id)
    {
        $data['idnya'] = $id;
    ...
    public function tampildatasuhan($kodemajikan, $kodegroup, $kodeagen)
    {
    ...
    public function tampilvisapermit($id)
    {
        $data['idnya'] = $id;
        $data['tampil_data_majikan'] = $this->m_majikans->tampil_data_majikandetail($id);
        $data['tampil_data_suhan'] = $this->m_majikans->tampil_data_suhandetail($id);
    ...
    public function tampiltkivisapermit($id)
    {
        $data['idnya'] = $id;
        $data['tampil_data_majikan'] = $this->m_majikans->tampil_data_majikandetail($id);
        $data['tampil_data_suhan'] = $this->m_majikans->tampil_data_suhandetail($id);
    ...
    public function tampildatavisapermit($kodesuhan, $kodemajikan, $kodeagen, $kodegroup)
    {
    ...
    public function ubahagensuhan($id)
    {
        if ($this->input->post('submit')) {
    ...
    public function ubahagenvisapermit($id)
    {
        if ($this->input->post('submit')) {
    ...
    public function select_agenlist3()
    {
        $idgrup = $this->input->post('kode_group');
    ...
    public function select_agenlist4()
    {
        $idgrup = $this->input->post('kode_group');
        $data['option_agen'] = $this->m_majikans->getagenlist_group($idgrup);
    ...
    public function select_majikanlist2()
    {
        $kodeagen = $this->input->post('kode_agen');
    ...
    public function simpan_data_majikan()
    {
        ...
        $sektor = $this->input->post('datasektor_id');
        ...
        $this->m_majikans->simpan_data_majikan($kode, $sektor, $nama, $hp, $email, $alamat, $status, $a, $b, $c, $d);
    ...
    public function simpan_data_suhandata()
    {
    ...
    public function simpan_data_visapermitdata()
    {
    ...
    public function update_data_suhandata($id, $kodemajikan, $kodegroup, $kodeagen)
    {
        if ($this->input->post('submit')) {
    ...
    public function update_data_majikan($id)
    {
        $data['status'] = $this->session->userdata("status");
    ...
    public function update_data_visapermitdata($id, $idsuhan, $kodemajikan, $kodegroup, $kodeagen)
    {
    ...
    public function hapus_suhandata()
    {
    ...
    public function hapus_visapermitdata()
    {
    ...
    public function update_history_suhan($id)
    {
    ...
    public function update_history_visapermit($id)
    {

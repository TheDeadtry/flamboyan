...
<!-- <a href="<?php echo site_url('pdf9/cetakvisapermit/'); ?>" class="btn btn-large btn-primary" type="button">Print Data VisaPermit</a> -->
...
<br><br>
 <div class="row-fluid">
   ...
   <thead>
                                        ...
                                        <td> <a href="<?php echo site_url('majikans/update_data_visapermitdata/'.$row->id_visapermit.'/'.$kodesuhan.'/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup); ?>" class="btn btn-mini btn-primary" type="button">Ubah</a>
                                     ...
                                     <td><a href="<?php echo base_url().'/assets/dokvisapermit/'.$row->filevisapermit;?>"<?php echo $row->filevisapermit;?>><img src="<?php echo base_url(); ?>assets/dokvisapermit/<?php echo "".$row->filevisapermit ?> "/></a> </td>
 ...
 <div class="modal fade" id="hapusvisapermit<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('majikans/hapus_visapermitdata'); ?>">
                           <div class="modal-header">
            ...
            <div class='actions'>
                ...
                <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <div class='box-content box-no-padding'>
                                      ...
                                      <form action="<?php echo site_url('majikans/simpan_data_visapermitdata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />

...
<div class='row-fluid' >
 ...
 <div class="row-fluid">
                            ...
                            <div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                               ...
                               <!-- <a href="<?php echo site_url('pdf9/cetaksuhan/'); ?>" class="btn btn-large btn-primary" type="button">Print Data Suhan</a> -->

                            <div class='box-header orange-background'>
                                <div class='title'>Data Suhan <?php echo $kodeagen;?></div>
                                <div class='actions'>
  ...
  <thead>
                                    ...
                                    <!--  <a href="<?php echo site_url('majikans/ubahagensuhan/'.$row->id_suhan); ?>"class="btn btn-mini btn-primary"></i>Edit Agen </a></br> -->
                                            <a href="<?php echo site_url('majikans/update_data_suhandata/'.$row->id_suhan.'/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup); ?>" class="btn btn-mini btn-primary" type="button">Ubah  Data</a>
                                        </br>
                                            ...
                                            <td>  <a class="btn btn-mini btn-primary" href="<?php echo site_url('majikans/tampilsuhan/'.$row->id_suhan); ?>" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">Tanggal Terima</a>
                                                ...
                                                <a class="btn btn-mini btn-primary" href="<?php echo site_url('majikans/tampildatavisapermit/'.$row->id_suhan.'/'.$kodemajikan.'/'.$kodegroup.'/'.$kodeagen); ?>" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">VISA PERMIT</a>
                                        ...
                                        <!-- <a href="<?php echo site_url('majikans/tampiltki/'.$row->id_suhan); ?>"class="btn btn-mini btn-primary"></i>Data TKI </a> -->
                                         ...
                                         <td><a href="<?php echo base_url().'/assets/doksuhan/'.$row->filesuhan;?>"<?php echo $row->filesuhan;?>><img src="<?php echo base_url(); ?>assets/doksuhan/<?php echo "".$row->filesuhan;?>"/></a></td>
 ...
 <div class="modal fade" id="hapussuhan<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('majikans/hapus_suhandata'); ?>">
                           <div class="modal-header">
                           ...
                           <div class="modal-body">
                             ...
                             <input type="hidden" class="form-control" name="id_suhan" value="<?php echo  $row->id_suhan; ?>">
                            <input type="hiddens" class="form-control" name="file" value="<?php echo $row->filesuhan; ?>">
  ...
  <div class='modal hide fade' id='tambaha' role='dialog' tabindex='-1'>
                ...
                <div class='modal-body'>
                                ...
                                <form action="<?php echo site_url('majikans/simpan_data_suhandata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                      ...
                                      <input type="hidden" class="form-control" name="group" value="<?php echo $kodegroup; ?>">
                                       <input type="hidden" class="form-control" name="kode_agen" value="<?php echo $kodeagen; ?>">
                                        ...
                                        <div class="control-group ">
                                            <label class="control-label">No Suhan </label>
                                            <div class="controls">
                                                <input type="text" name="no" class="span4 popovers"/>
                                            </div>
                                        </div>

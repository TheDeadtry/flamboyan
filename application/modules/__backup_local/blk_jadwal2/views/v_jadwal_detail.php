                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo site_url('blk_jadwal2/jadwal_detail_add_tki_manual/'.$v_id); ?>" class="form-horizontal" method="post">
                                                    ...
                                                    <input type="hidden" name="vie_hari" value="<?php echo $this->session->userdata('jadwal_detail_hari'); ?>">
                                                    <input type="hidden" name="vie_jam" value="<?php echo $this->session->userdata('jadwal_detail_jam'); ?>">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <?php 
                                                                            $cfrhari = $this->M_session->select_row("SELECT * FROM blk_hari WHERE kode_hari='".$this->session->userdata('jadwal_detail_hari')."'");
                                                                        ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <?php 
                                                                            $cfrjam = $this->M_session->select_row("SELECT * FROM blk_jam WHERE kode_jam='".$this->session->userdata('jadwal_detail_jam')."'");
                                                                        ?>
                                        ...
                                        <table class="table table-xxs table-bordered table-striped table-hover" id="jadwaltables">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center"><?php echo $hdr; ?></td>

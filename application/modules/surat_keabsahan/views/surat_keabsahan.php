                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>index.php/new_pdf_pp/keabsahan_akte_kelahiran/<?php echo $row->id_biodata.'/'.$row->id_pembuatan;?>"  class="btn btn-warning">Print Keabsahan Akte Kelahiran</a><br>
                                            <a href="<?php echo base_url(); ?>index.php/new_pdf_pp/keabsahan_nik_ktp/<?php echo $row->id_biodata.'/'.$row->id_pembuatan;?>"  class="btn btn-warning">Print Keabsahan NIK KTP</a></td>

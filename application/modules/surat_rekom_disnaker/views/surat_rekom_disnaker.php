                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>index.php/printdata/cetakdisnaker/<?php echo $row->id_pembuatan;?>"  class="btn btn-warning">Print</a>
                                            <a href="<?php echo base_url(); ?>index.php/new_pdf_ceklist/forms/<?php echo $row->id_pembuatan;?>"  class="btn btn-success">Print Baru</a>
                                            </td>

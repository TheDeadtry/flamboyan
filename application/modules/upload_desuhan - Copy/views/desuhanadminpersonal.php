        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload suhan  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="alert alert-info">
                        ...
                        <a class='btn btn-info btn-large' data-toggle='modal' href='#tambah' role='button'>Tambah Data</a>
                          <a class='btn btn-info btn-large' data-toggle='modal' href='<?php echo site_url().'/majikans/suhan'; ?>' role='button'>Kembali</a>
                        </div>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header orange-background'>
                                <div class='title'>Dokumen suhan</div>
                                <div class='actions'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_desuhan as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            ...
                                            <td><?php echo $row->penting;?></td>
                                             <td><?php echo $row->cekdokumen;?></td>
                                              <td><?php echo $row->tglterima;?></td>
                                               ...
                                               <td><a class='btn btn-danger' href="<?php echo base_url().'assets/upload_desuhan/'.$row->file;?>"><?php echo $row->file;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    ...
                    <h3>Update desuhan</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('upload_desuhan/update_data_desuhan/'.$idsuhan); ?>">
                           <div class="modal-body">
                           

                          <input type="hidden" class="form-control" name="id_desuhan" value="<?php echo $row->id_desuhan; ?>">
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_desuhan/hapus_data_desuhan/'.$idsuhan); ?>">
                           <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                             <h4 class="modal-title">Hapus Data desuhan</h4>
                           </div>
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id_desuhan" value="<?php echo $row->id_desuhan; ?>">
...
<div class='modal hide fade' id='tambah' role='dialog' tabindex='-2'>
                <div class='modal-header'>
                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                    <h3>Tambah desuhan</h3>
                </div>
                <div class='modal-body'>
<form action="<?php echo site_url('upload_desuhan/simpan_data_desuhan/'.$idsuhan);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />

<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idsuhan ?>" class="hidden" />

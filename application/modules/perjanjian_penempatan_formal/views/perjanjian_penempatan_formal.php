          ...
          <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="4"><a href="<?php echo base_url(); ?>index.php/baru1/cetak/<?php echo $row->id_biodata;?>" class="btn btn-warning" >Print</a></td>
              </tr>
            <div id="myModal2<?php echo $no; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
              ...
              <div class="modal-body" >
                <form action="<?php echo site_url('perjanjian_penempatan_formal/edit_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
            ...
            <div id="hapus<?php echo $no; ?>" class="modal hide fade" tabindex="-hapus" role="dialog" aria-labelledby="hapus" aria-hidden="true">
              ...
              <div class="modal-body">
                <form action="<?php echo site_url('perjanjian_penempatan_formal/hapus_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
            ...
            <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
              ...
              <div class="modal-body" >
                <form action="<?php echo site_url('perjanjian_penempatan_formal/simpan_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                <div class="control-group">
                  <label class="control-label">Nama TKI</label>
                  <div class="controls">
                    <select name="id_biodata" class="form-control select-search" >

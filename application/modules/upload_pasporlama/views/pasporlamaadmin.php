    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Upload Paspor Lama </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload Paspor Lama  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
            ...
            <div class='title'>Dokumen Paspor Lama</div>
            <div class='actions'>
...
<?php if($hitungan==0){?>
               <div class="row-fluid">
                            ...
                            <div class='box-header orange-background'>
                                <div class='title'>Data UPLOAD pasporlama</div>
                                <div class='actions'>
                                    <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                    </a>
                                    <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <form action="<?php echo site_url('upload_pasporlama/simpan_data_pasporlama');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
...
<?php foreach ($tampil_data_pasporlama as $row) { ?>
                            <form action="<?php echo site_url('upload_pasporlama/update_data_pasporlama');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
<br>
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
<input type="hidden" class="form-control" name="id_pasporlama" value="<?php echo $row->id_pasporlama; ?>">
        ...
        <div class='row-fluid'>
            <div class=' box-quick-link blue-background'>
                  <!-- <a href='<?php echo site_url().'/tambah1/cetak/'.$detailpersonalid; ?>' target="_blank"> -->
                                    <a href='<?php echo site_url().'/upload_pasporlama/uploadfile/'.$detailpersonalid; ?>'>
                    <div class='header'>
...
<li>
    <div class='picture'>
        ...
        <div class='actions'>
         ...
         <a href="<?php echo base_url().'upload-foto/'.$rows->namafile;?>"<?php echo $rows->namafile;?>>
                                                        <?php if (strpos($rows->namafile, '.doc') !== false){?>
                                                          <img width="200" src="<?php echo base_url(); ?>assets/dokmajikan/nodok.jpg"/></a> 
                                                        <?php }else{?>
                                                           <img width="200" src="<?php echo base_url(); ?>upload-foto/<?php echo "".$rows->namafile ?>"/></a> 
                                                        <?php } ?>
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-1" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('upload_pasporlama/hapus_data_pasporlama'); ?>">
                           <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                             <h4 class="modal-title">Hapus Data pasporlama</h4>
                           </div>

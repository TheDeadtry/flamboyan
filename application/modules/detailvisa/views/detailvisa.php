        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Detail Personal
        ...
        ?>
                ...
                <div class="span6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="novisa" value="<?php echo $tanggaltiba;?>" class="span7 popovers"
                                data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP"
                                data-original-title="Nama Lengkap" />
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <button data-dismiss="alert" class="close"> x </button> Silahkan menambahkan data pada tombol
                        ini...
                        <a class='btn btn-info btn-large' data-toggle='modal' href='#tambah' role='button'>Tambah
                            Data</a>
                    </div>
                    <?php
                                }else{ ?>
                    ...
                    <div class="alert alert-info">
                        ...
                        <button data-dismiss="alert" class="close"> x </button> silahkan mengubah data pada tombol
                        ini...
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->tglberlaku." - ".$row->expired ?>
                                </td>
                            </tr>
 ...
 <tr>
                            ...
                            <tr>
                                <td class="span3" colspan='2'>
                                    <div class="alert alert-info"><button data-dismiss="alert" class="close"> x
                                        </button> Data DOKUMEN DIBAWA TKI</div>
                                </td>
                            <tr>
                                <td class="span3"> Apendik A :</td>
                                <td>
                                    <?php echo $row->apendik_a;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3"> Apendik B :</td>
                                <td>
                                    <?php echo $row->apendik_b;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3"> Apendik C :</td>
                                <td>
                                    <?php echo $row->apendik_c;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3"> Apendik D :</td>
                                <td>
                                    <?php echo $row->apendik_d;?>
                                </td>
                            </tr>
                            </tr>
                            ...
                            <tr>
                                <td class="span3" colspan='2'>
                                    <div class="alert alert-info">
                                        <button data-dismiss="alert" class="close"> x </button> Data SUhan
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->statsuhandok;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3"> 正本? :</td>
                                <td>
                                    <?php echo $row->tempatsuhandok;?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->ketdoksuhan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3" colspan='2'>
                                    <div class="alert alert-info">
                                        <button data-dismiss="alert" class="close"> x </button> Data Visa Permit
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3"> Status Dokumen :</td>
                                <td>
                                    <?php echo $row->statvpdok;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3"> 正本? :</td>
                                <td>
                                    <?php echo $row->tempatvpdok;?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->ketdokvp;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3" colspan='2'>
                                    <div class="alert alert-info">
                                        <button data-dismiss="alert" class="close"> x </button> Data Titipan
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->id_biodata_titipan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NAMA:</td>
                                <td>
                                    <?php echo $row->nama_titipan;?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->tgl_terbang_titipan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NO.SUHAN TITIPAN:</td>
                                <td>
                                    <?php echo $row->no_suhan_titipan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NO VISAPERMIT TITIPAN:</td>
                                <td>
                                    <?php echo $row->no_vp_titipan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3" colspan='2'>
                                    <div class="alert alert-info">
                                        <button data-dismiss="alert" class="close"> x </button> Data Suhan diTitipkan
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">ID:</td>
                                <td>
                                    <?php echo $row->id_biodata_dititipkan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NAMA:</td>
                                <td>
                                    <?php echo $row->nama_dititipkan;?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row->tgl_terbang_dititipkan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NO.SUHAN DITITIPKAN:</td>
                                <td>
                                    <?php echo $row->no_suhan_dititipkan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3" colspan='2'>
                            ...
                            <tr>
                                <td class="span3">ID:</td>
                                <td>
                                    <?php echo $row->id_biodata_dititipkan2;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NAMA:</td>
                                <td>
                                    <?php echo $row->nama_dititipkan2;?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="span3"> TANGGAL TERBANG DITITIPKAN:</td>
                                <td>
                                    <?php echo $row->tgl_terbang_dititipkan2;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">NO VISAPERMIT DITITIPKAN:</td>
                                <td>
                                    <?php echo $row->no_vp_dititipkan;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3" colspan='2'>
                                    <div class="alert alert-info">
                                        <button data-dismiss="alert" class="close"> x </button> Data Detail Dokumen
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="span3">
                                    <?php echo $row->mandarinnya;?>
                                </td>
                                <!-- <td> <?php echo $row->mandarinnya;?> </td> -->
                            </tr>
                            <tr>
                                <td class="span3">
                                    <?php echo $row->mandarinnya2;?>
                                </td>
                            ...
                            <tr>
                                <td class="span3">
                                    <?php echo $row->isidok3;?>
                                </td>
                                <td>
                                    <?php echo $row->statdok3;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">
                                    <?php echo $row->isidok4;?>
                                </td>
                                <td>
                                    <?php echo $row->statdok4;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">
                                    <?php echo $row->isidok5;?>
                                </td>
                                <td>
                                    <?php echo $row->statdok5;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">
                                    <?php echo $row->isidok6;?>
                                </td>
                                <td>
                                    <?php echo $row->statdok6;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">
                                    <?php echo $row->isidok7;?>
                                </td>
                                <td>
                                    <?php echo $row->statdok7;?>
                                </td>
                            </tr>
                            <tr>
                                <td class="span3">
                                    <?php echo $row->isidok8;?>
                                </td>
                                <td>
                                    <?php echo $row->statdok8;?>
                                </td>
                            </tr>
                ...
                <div class='span3 box box-transparent'>
                    ...
                    <div class='row-fluid'>
                        <div class=' box-quick-link blue-background'>
                            <a href='<?php echo site_url().'/pdf7/cetakdokdibawa/'.$detailpersonalid;
                                ?>'>
                                <div class='header'>
                        ...
                        <br>
                        <div class=' box-quick-link blue-background'>
                            <a href='<?php echo site_url().'/apendik/document_send_taiwan/'.$detailpersonalid; ?>'>
                                <div class='header'>
                                    <div class='icon-book'></div>
                                </div>
                        ...
                        <br>
                        <div class=' box-quick-link blue-background'>
                            <a href='<?php echo site_url().'/apendik/document_sebelum_terbang/'.$detailpersonalid; ?>'>
                                <div class='header'>
                                    <div class='icon-book'></div>
                                </div>
    ...
    <div class='modal hide fade' id='tambah' role='dialog' tabindex='-1'>
        ...
        <div class='modal-body'>
            <form action="<?php echo site_url('detailvisa/tambahvisa');?>" enctype="multipart/form-data" method="post"
                class="form-horizontal" />

            <input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>"
                class="hidden" />

            <div class="control-group">
                <label class="control-label span4"> No Visa </label>
                <div class="controls">
                    <input type="text" name="novisa" class="span7 popovers" data-trigger="hover"
                        data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglberlaku"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglkocokan"
                            placeholder='Select datepicker' type='text' />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglfinger"
                            placeholder='Select datepicker' type='text' />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglterima"
                            placeholder='Select datepicker' type='text' />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="nopap" class="span7 popovers" data-trigger="hover"
                        data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglpap"
                            placeholder='Select datepicker' type='text' />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglktkln"
                            placeholder='Select datepicker' type='text' />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
            ...
            <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Inputan Data DOKUMEN
                DIBAWA TKI</div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="ketdoksuhan" class="span12 popovers" data-trigger="hover"
                        data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
                </div>
            </div>
            ...
            <div class="control-group">
                <label class="control-label span4"> KETERANGAN 備註 </label>
                <div class="controls">
                    <input type="text" name="ketdokvp" class="span12 popovers" data-trigger="hover"
                        data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok3">
                        <option value="" />Select...
                        <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                        <option value="<?php echo $pilihan->isi;?>" />
                        <?php echo $pilihan->isi;?>
            ...
            <div class="control-group">
                <label class="control-label span4"> KETERANGAN 備註 </label>
                <div class="controls">
                    <input type="text" name="ketdok" class="span12 popovers" data-trigger="hover"
                        data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
                </div>
            </div>
    ...
    <div class='modal hide fade' id='ubah' role='dialog' tabindex='-1'>
        ...
        <div class='modal-body'>
            <form id="updatevisa" action="<?php echo site_url('detailvisa/ubahvisa');?>" enctype="multipart/form-data" method="post"
                class="form-horizontal" />
            <?php foreach ($tampil_data_visa as $row) { ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input 
                        type="text" 
                        name="novisa" 
                        class="span7 popovers" 
                        data-trigger="hover"
                        data-content="Isi Nama Lengkap Sesuai dengan KTP" 
                        data-original-title="Nama Lengkap"
                        value="<?php echo $row->novisa;?>" 
                    />
                </div>
            </div>

            <div class="control-group">
                <label class="control-label">Tanggal Berlaku Darii</label>
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglberlaku"
                            placeholder='Select datepicker' type='text' value="<?php echo $row->tglberlaku;?>" />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
                    </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglkocokan"
                            placeholder='Select datepicker' type='text' value="<?php echo $row->kocokan;?>" />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
                    </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglfinger"
                            placeholder='Select datepicker' type='text' value="<?php echo $row->finger;?>" />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
                    </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglterima"
                            placeholder='Select datepicker' type='text' value="<?php echo $row->terima;?>" />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
                    </div>
            ...
            <div class="control-group">
                <label class="control-label span4"> Nomor PAP </label>
                <div class="controls">
                    <input type="text" name="nopap" class="span7 popovers" value="<?php echo $row->nopap;?>"
                        data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP"
                        data-original-title="Nama Lengkap" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglpap"
                            placeholder='Select datepicker' type='text' value="<?php echo $row->pap;?>" />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
                    </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy.MM.dd' name="tglktkln"
                            placeholder='Select datepicker' type='text' value="<?php echo $row->ktkln;?>" />
                        <span class='add-on'>
                            <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                        </span>
                    </div>
                ...
                <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Inputan DOKUMEN
                    DIBAWA TKI</div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="apendik_a">
                            ...
                            <option selected="selected" value="<?= $data_apendik_a[$i] ?>">
                                <?= $data_apendik_a_isi[$i] ?>
                            </option>
                            <?php else : ?>
                            <option value="<?= $data_apendik_a[$i] ?>">
                                <?= $data_apendik_a_isi[$i] ?>
                            </option>
                            <?php endif; ?>
                            <?php endfor; ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="apendik_b">
                            ...
                            <option selected="selected" value="<?= $data_apendik_b[$i] ?>">
                                <?= $data_apendik_b_isi[$i] ?>
                            </option>
                            <?php else : ?>
                            <option value="<?= $data_apendik_b[$i] ?>">
                                <?= $data_apendik_b_isi[$i] ?>
                            </option>
                            <?php endif; ?>
                            <?php endfor; ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="apendik_c">
                            ...
                            <option selected="selected" value="<?= $data_apendik_c[$i] ?>">
                                <?= $data_apendik_c_isi[$i] ?>
                            </option>
                            <?php else : ?>
                            <option value="<?= $data_apendik_c[$i] ?>">
                                <?= $data_apendik_c_isi[$i] ?>
                            </option>
                            <?php endif; ?>
                            <?php endfor; ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="apendik_d">
                            ...
                            <option selected="selected" value="<?= $data_apendik_d[$i] ?>">
                                <?= $data_apendik_d_isi[$i] ?>
                            </option>
                            <?php else : ?>
                            <option value="<?= $data_apendik_d[$i] ?>">
                                <?= $data_apendik_d_isi[$i] ?>
                            </option>
                            <?php endif; ?>
                            <?php endfor; ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statsuhandok">
                            <option value="<?php echo $row->statsuhandok;?>" />
                            <?php echo $row->statsuhandok;?>
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                            <option value="沒有-TIDAK ADA" />沒有-TIDAK ADA
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="tempatsuhandok">
                            <option value="<?php echo $row->tempatsuhandok;?>" />
                            <?php echo $row->tempatsuhandok;?>
                            <option value="放印尼 DI INDONESIA" />放印尼 DI INDONESIA
                            <option value="寄臺灣KE TAIWAN" />寄臺灣KE TAIWAN
                        </select>
                ...
                <div class="control-group">
                    <label class="control-label span4"> KETERANGAN 備註 </label>
                    <div class="controls">
                        <input type="text" name="ketdoksuhan" class="span12 popovers"
                            value="<?php echo $row->ketdoksuhan;?>" data-trigger="hover"
                            data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
                    </div>
                </div>

                <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Data Visapermit
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statvpdok">
                            <option value="<?php echo $row->statvpdok;?>" />
                            <?php echo $row->statvpdok;?>
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                            <option value="沒有-TIDAK ADA" />沒有-TIDAK ADA
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="tempatvpdok">
                            <option value="<?php echo $row->tempatvpdok;?>" />
                            <?php echo $row->tempatvpdok;?>
                            <option value="放印尼 DI INDONESIA" />放印尼 DI INDONESIA
                            <option value="寄臺灣KE TAIWAN" />寄臺灣KE TAIWAN
                ...
                <div class="control-group">
                    <label class="control-label span4"> KETERANGAN 備註 </label>
                    <div class="controls">
                        <input type="text" name="ketdokvp" class="span12 popovers" value="<?php echo $row->ketdokvp;?>"
                            data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP"
                            data-original-title="Nama Lengkap" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nama_titipan" class="span12 popovers"
                            value="<?php echo $row->nama_titipan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> ID </label>
                    <div class="controls">
                        <input type="text" name="id_biodata_titipan" class="span12 popovers"
                            value="<?php echo $row->id_biodata_titipan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4">NO SUHAN</label>
                    <div class="controls">
                        <input type="text" name="no_suhan_titipan" class="span12 popovers"
                            value="<?php echo $row->no_suhan_titipan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> NO VISAPERMIT </label>
                    <div class="controls">
                        <input type="text" name="no_vp_titipan" class="span12 popovers"
                            value="<?php echo $row->no_vp_titipan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class='datepicker input-append' id='datepicker'>
                            <input class='input-medium' data-format='yyyy.MM.dd' name="tgl_terbang_titipan"
                                placeholder='Select datepicker' type='text'
                                value="<?php echo $row->tgl_terbang_titipan;?>" />
                            <span class='add-on'>
                                <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                            </span>
                        </div>
                ...
                <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Data Suhan
                    Dititipkan</div>

                <div class="control-group">
                    <label class="control-label span4"> NAMA</label>
                    <div class="controls">
                        <input type="text" name="nama_dititipkan" class="span12 popovers"
                            value="<?php echo $row->nama_dititipkan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> ID </label>
                    <div class="controls">
                        <input type="text" name="id_biodata_dititipkan" class="span12 popovers"
                            value="<?php echo $row->id_biodata_dititipkan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4">NO SUHAN</label>
                    <div class="controls">
                        <input type="text" name="no_suhan_dititipkan" class="span12 popovers"
                            value="<?php echo $row->no_suhan_dititipkan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> Tanggal Terbang di titipkan </label>
                    <div class="controls">
                        <div class='datepicker input-append' id='datepicker'>
                            <input class='input-medium' data-format='yyyy.MM.dd' name="tgl_terbang_dititipkan"
                                placeholder='Select datepicker' type='text'
                                value="<?php echo $row->tgl_terbang_dititipkan;?>" />
                            <span class='add-on'>
                                <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                            </span>
                        </div>
                ...
                <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Data Visa Permit
                    Dititipkan</div>

                <div class="control-group">
                    <label class="control-label span4"> NAMA</label>
                    <div class="controls">
                        <input type="text" name="nama_dititipkan2" class="span12 popovers"
                            value="<?php echo $row->nama_dititipkan2;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> ID </label>
                    <div class="controls">
                        <input type="text" name="id_biodata_dititipkan2" class="span12 popovers"
                            value="<?php echo $row->id_biodata_dititipkan2;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> NO VISAPERMIT </label>
                    <div class="controls">
                        <input type="text" name="no_vp_dititipkan" class="span12 popovers"
                            value="<?php echo $row->no_vp_dititipkan;?>" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label span4"> Tanggal Terbang di titipkan </label>
                    <div class="controls">
                        <div class='datepicker input-append' id='datepicker'>
                            <input class='input-medium' data-format='yyyy.MM.dd' name="tgl_terbang_dititipkan2"
                                placeholder='Select datepicker' type='text'
                                value="<?php echo $row->tgl_terbang_dititipkan2;?>" />
                            <span class='add-on'>
                                <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                            </span>
                        </div>
                ...
                <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Detail Dokumen
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="jddok">
                            <option value="<?php echo $row->jddok;?>" />
                            <?php echo $row->jddok;?>
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                            <option value="沒有-TIDAK ADA" />沒有-TIDAK ADA
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="arcdok">
                            <option value="<?php echo $row->arcdok;?>" />
                            <?php echo $row->arcdok;?>
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                            <option value="沒有-TIDAK ADA" />沒有-TIDAK ADA
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="icdok">
                            <option value="<?php echo $row->icdok;?>" />
                            <?php echo $row->icdok;?>
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                            <option value="沒有-TIDAK ADA" />沒有-TIDAK ADA
                ...
                <div class="alert alert-info"><button data-dismiss="alert" class="close"> x </button> Dokumen Lainnya
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok3">
                            <option value="<?php echo $row->isidok3;?>" />
                            <?php echo $row->isidok3;?>
                            <option value="" />
                            <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                            <option value="<?php echo $pilihan->isi;?>" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statdok3">
                            <option value="<?php echo $row->statdok3;?>" />
                            <?php echo $row->statdok3;?>
                            <option value="" />
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok4">
                            <option value="<?php echo $row->isidok4;?>" />
                            <?php echo $row->isidok4;?>
                            <option value="" />
                            <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                            <option value="<?php echo $pilihan->isi;?>" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statdok4">
                            <option value="<?php echo $row->statdok4;?>" />
                            <?php echo $row->statdok4;?>
                            <option value="" />
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok5">
                            <option value="<?php echo $row->isidok5;?>" />
                            <?php echo $row->isidok5;?>
                            <option value="" />
                            <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                            <option value="<?php echo $pilihan->isi;?>" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statdok5">
                            <option value="<?php echo $row->statdok5;?>" />
                            <?php echo $row->statdok5;?>
                            <option value="" />
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok6">
                            <option value="<?php echo $row->isidok6;?>" />
                            <?php echo $row->isidok6;?>
                            <option value="" />
                            <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                            <option value="<?php echo $pilihan->isi;?>" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statdok6">
                            <option value="<?php echo $row->statdok6;?>" />
                            <?php echo $row->statdok6;?>
                            <option value="" />
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok7">
                            <option value="<?php echo $row->isidok7;?>" />
                            <?php echo $row->isidok7;?>
                            <option value="" />
                            <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                            <option value="<?php echo $pilihan->isi;?>" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statdok7">
                            <option value="<?php echo $row->statdok7;?>" />
                            <?php echo $row->statdok7;?>
                            <option value="" />
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="isidok8">
                            <option value="<?php echo $row->isidok8;?>" />
                            <?php echo $row->isidok8;?>
                            <option value="" />
                            <?php  foreach ($tampil_data_pildok as $pilihan) { ?>
                            <option value="<?php echo $pilihan->isi;?>" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="statdok8">
                            <option value="<?php echo $row->statdok8;?>" />
                            <?php echo $row->statdok8;?>
                            <option value="" />
                            <option value="正本-ORIGINAL" />正本-ORIGINAL
                            <option value="影本-COPY" />影本-COPY
                ...
                <div class="control-group">
                    <label class="control-label span4"> KETERANGAN 備註 </label>
                    <div class="controls">
                        <input type="text" name="ketdok" class="span12 popovers" value="<?php echo $row->ketdok;?>"
                            data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP"
                            data-original-title="Nama Lengkap" />
                    </div>
                </div>

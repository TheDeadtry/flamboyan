						...
						<div class="modal-content">
							...
							<form action="<?php echo site_url('formulir_blk/simpan_data_formulir_blk'); ?>" class="form-horizontal" method="post">
								<div class="modal-body">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Nama BLK </label>
										<div class="col-sm-9">
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-location3"></i></span>
												<input type="text" class="form-control" name="nama_blk" placeholder="Nama BLK" />
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Tempat Uji </label>
										<div class="col-sm-9">
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-location3"></i></span>
												<input type="text" class="form-control" name="tmp_uji" placeholder="Tempat Uji" />
											</div>
										</div>
									</div>
								</div>
														...
														<div class="form-group">
															<div class="row">
																...
																<div class="col-sm-9">
																	<div class="input-group">
																		<span class="input-group-addon"><i class="icon-location3"></i></span>
																		<input type="text" class="form-control" name="nama_blk" placeholder="Nama BLK" value="<?php echo $row->nama_blk; ?>" />
																	</div>
																</div>
															</div>
														</div>
														<div class="form-group">
															<div class="row">
																...
																<div class="col-sm-9">
																	<div class="input-group">
																		<span class="input-group-addon"><i class="icon-location3"></i></span>
																		<input type="text" class="form-control" name="tmp_uji" placeholder="Tempat Uji" value="<?php echo $row->tmp_uji; ?>" />
																	</div>
																</div>
															</div>
														</div>

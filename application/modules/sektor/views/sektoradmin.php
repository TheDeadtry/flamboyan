...
<?php echo form_open('sektor/simpan_data_sektor', array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                                   ...
                                   <div class="control-group">
                                    ...
                                    <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="bank" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
                                    <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span10 " data-placeholder="Choose a Category" tabindex="1" name="jenis_kelamin">
                                                                        <option value="" />Select...
                                                                        <option value="男 Laki-Laki" />男 Laki-Laki
                                                                        <option value="女 Perempuan" />女 Perempuan
                                                                        </select>
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span10" required data-placeholder="Choose a Category" tabindex="1" name="status">
                                                                        <option value="" />Select...
                                                                        <option value="formal" /> Formal
                                                                        <option value="informal" /> Informal
                                                                        <option value="jompo" /> Jompo
                                                                        </select>
                                                                </div>
                                                            </div>

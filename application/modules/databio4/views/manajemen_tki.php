<div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4> <span class="text-semibold">PKL</span> - BLK</h4>

                <ul class="breadcrumb breadcrumb-caret position-right">
                    <li><a href="index.html">Personal BLK</a></li>
                    <li><a href="user_pages_profile.html">Rekapitulasi PKL - Wanita Informal</a></li>
                </ul>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="#" class="btn btn-link btn-float has-text"><i class="icon-user"></i><span>Rekapitulasi PKL - Wanita Informal</span></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-flat">
                            ...
                            <div class="row" >
                                ...
                                <form method="get" action="">
                            		<div class="input-group">
                                            ...
                                            <input type="text" name="query" class="form-control" placeholder="Search for..." value="<?php echo $query?>">
                            ...
                            <div class="table-responsive" >
                            		<table id="example2" class="table table-bordered text-center" style="border-top: 1px solid lightgrey;">
                            			<thead>
                            				<tr>
                            					<th rowspan="3" class="text-center">STATUS</th>
                            					<th colspan="10" class="text-center">BIODATA DAN DISNAKER ONLINE</th>
                            			...
                            			<tbody>
                            				<?php
                                                foreach ($tampil_data->result() as $row) { ?>
                                                    <tr>
                                                        <td>s</td>
                                                        <td>s</td>
                                                        <td>s</td>
                            		...
                            		<div class="text-center">
                            			<nav aria-label="Page navigation">
                                          ...
                                          <?php
                                            ...
                                            ?>
										    <li>
										      <a href="?page=1&query=<?php echo $query;?>" aria-label="Previous">
										        <span aria-hidden="true">&laquo;</span>
										      </a>
										    </li>
                                            <li>
                                              <a href="?page=<?php echo $page-1;?>&query=<?php echo $query;?>" aria-label="Previous">
                                            ...
                                            <?php
                                                ...
                                                for ($i=1; $i <= $jumlah ; $i++) { 
                                                    ...
                                                    echo '<li '.$sel.'><a href="?page='.$i.'&query='.$query.'" >'.$i.'</a></li>';
                                                }
                                        ...
                                        if ($page==$jumlah) {
                                            ...
                                            ?>
										    <li>
										      <a href="?page=<?php echo $page+1;?>&query=<?php echo $query?>" aria-label="Next">
										        <span aria-hidden="true">&rsaquo;</span>
										      </a>
										    </li>
                                            <li>
                                              <a href="?page=<?php echo $jumlah;?>&query=<?php echo $query?>" aria-label="Next">

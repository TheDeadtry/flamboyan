            ...
            <div class="col-lg-9">
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo site_url('blk_bhs_taiyu/setdata/'.$idbio) ?>" method="POST">
                            <?php 
                        ...
                        <table class="table table-lg datatable-basic table-bordered table-striped">
                            ...
                            <tbody> 
                                ...
                                <div class="modal fade" id="tambahm" tabindex="-2" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form class="form-horizontal" method="post" action="<?php echo site_url('blk_bhs_taiyu/tambah_nilai/'.$idbio); ?>">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select name="materi" class="form-control">
                                                                        ...
                                                                        ?>
                                                                            <option value="<?php echo $materi->id_bhs_taiyu ?>"><?php echo $materi->kode_materi.' : '.$materi->nama_materi ?></option>
                                                                        <?php
                                                                            }
                                                                        ?>
                                                                    </select>
                                 ...
                                 <?php 
                                    ...
                                    //foreach ($tampil_data_bhs_taiyu as $hasil) {
                                        $count  = $this->M_blk_bhs_taiyu->tampil_data_count($group->tgl,$idbio);
                                        //for($q=1;$q<=$count->total;$q++) {
                                            $h  = $this->M_blk_bhs_taiyu->tampil_data_bhs_taiyu($group->tgl,$idbio);
                                            foreach ($h as $hasil) {
                                         $no++;
                                        $id                 = $hasil->idpgl;
                                        ...
                                        $nilai_tulis        = $this->M_blk_bhs_taiyu->get_nilai($hasil->nt);
                                        $nilai_praktek      = $this->M_blk_bhs_taiyu->get_nilai($hasil->np);
                                        $row[$no]           = $count->total;
                                        
                                        $count_penilai = $this->M_blk_bhs_taiyu->tampil_data_count2($group->tgl,$idbio,$hasil->id_instruktur);

                                        //$tampil_data_laundry   = $this->M_blk_bhs_taiyu->tampil_data_laundry($group->tgl,$idbio);
                                        //$data['tampil_data_count']      = $this->M_blk_bhs_taiyu->tampil_data_count($idbio);
                                        if ($row[$no] > 1) {
                                            if ($tgl[$no-1] == $tgl[$no]) {
                                                $c++;
                                            } else {
                                ...
                                <div class="modal fade" id="ubah<?php echo $no ?>" tabindex="-2" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form class="form-horizontal" method="post" action="<?php echo site_url('blk_bhs_taiyu/ubah_nilai/'.$idbio); ?>">
                                                <div class="modal-header bg-primary">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icon-user"></i></span>
                                                                    <select name="materi" class="form-control">
                                                                        <option class="tatagraha_penilai" id="namapenilai" value="<?php echo $hasil->id_bhs_taiyu ?>"><?php echo $materi ?></option>
                                                                        <div class="list-group-divider"></div>
                                                                        <?php 
                                                                            foreach ($tampil_data_blk_materi as $materi) {
                                                                        ?>
                                ...
                                <div id="hapus<?php echo $no; ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo site_url('blk_bhs_taiyu/hapus_nilai/'.$idbio); ?>" class="form-horizontal" method="post">                                       
                                                <div class="modal-body">
                                    ...
                                    <table class="table table-lg datatable-basic table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            foreach($tampil_data_blk_materi as $erds) {
                                                $no++;
                                                $teori_kali     = $this->M_blk_bhs_taiyu->ambil_kali('nilai_a_id',$idbio,$erds->id_bhs_taiyu);
                                                $teori_rata     = $this->M_blk_bhs_taiyu->ambil_rata($idbio,$erds->id_bhs_taiyu,'nilai_a');
                                                $praktek_kali   = $this->M_blk_bhs_taiyu->ambil_kali('nilai_b_id',$idbio,$erds->id_bhs_taiyu);
                                                $praktek_rata   = $this->M_blk_bhs_taiyu->ambil_rata($idbio,$erds->id_bhs_taiyu,'nilai_b');
                                        ?>
                                            <tr>
                                                <td><?php echo $no ?></td>

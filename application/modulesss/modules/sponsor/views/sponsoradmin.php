                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">Data Sponsor<small>Berisi semua Sponsor perusahaan</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Data</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Sponsor</a><span class="divider-last">&nbsp;</span></li>
...
<div class="alert alert-info">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span5">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Input sponsor</h4><span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;" class="icon-remove"></a></span></div>
                                <div class="widget-body">

                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">Pendidikan Data <small>Berisi semua pilihan Pendidikan untuk inputan</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Setting</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Pendidikan</a><span class="divider-last">&nbsp;</span></li>

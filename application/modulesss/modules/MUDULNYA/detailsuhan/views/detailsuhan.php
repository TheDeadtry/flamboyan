...
<!--                                         <li><a href="javascript:void(0)"><i class="icon-user-md"></i> Interview Appraisal</a></li>
 -->
                                ...
                                <div class="span6">
                                    <h4><?php echo $row->nama;?> <br /><small><?php echo "".$detailsuhanid ?></small></h4>
                                <?php }?>
<?php   
                                  if($hitungsuhan==0){
                                ?>
<div class="alert alert-info">
                        ...
                        <button data-dismiss="alert" class="close"> x </button> silahkan mengubah data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahsuhan/"?>" class="btn btn-mini btn-primary">Ubah data</a>
                        </div>

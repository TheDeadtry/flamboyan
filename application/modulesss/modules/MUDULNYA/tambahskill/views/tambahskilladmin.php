...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="hidden" />
                                ...
                                <div class="control-group">
						                                    ...
						                                    <div class="controls">
						                                        <select data-placeholder="Pilih Kondisi Mata" name="mata[]" id="mata" class="chosen span7" multiple="multiple" tabindex="15">
						                                            <option value="" />
						                                         <optgroup label="lolos">
						                                            	<option value="lolos 合格" />lolos 合格
						                                         </optgroup>


						                                             <optgroup label="memakai kacamata minus 戴眼鏡近視">
						                                            	<?php 
						                                            	for($i=1;$i<=5;$i++){?>

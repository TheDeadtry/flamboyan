...
<div class="alert alert-info">
                        ...
                        <button data-dismiss="alert" class="close"> x </button> silahkan mengubah data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahvisapermit/"?>" class="btn btn-mini btn-primary">Ubah data</a>
                        </div>

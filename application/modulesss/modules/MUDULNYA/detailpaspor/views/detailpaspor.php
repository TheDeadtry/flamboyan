                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title"> Detail Pasport <small>Detail paspor Pasport</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Admin</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Detail Pasport</a><span class="divider-last">&nbsp;</span></li>
...
<!--                                         <li><a href="javascript:void(0)"><i class="icon-user-md"></i> Interview Appraisal</a></li>
 -->
                                ...
                                <div class="span6">
                                    <h4><?php echo $row->nama;?> <br /><small><?php echo "".$detailpasporid ?></small></h4>
                                <?php }?>
<?php   
                                  if($hitungpaspor==0){
                                ?>
<div class="alert alert-info">
                        ...
                        <button data-dismiss="alert" class="close"> x </button> Silahkan menambahkan data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahpaspor/"?>" class="btn btn-mini btn-primary">Tambah data paspor</a>
                        </div>
                                 <?php
                                }else{ ?>
                                <div class="alert alert-info">
                        
                        <button data-dismiss="alert" class="close"> x </button> silahkan mengubah data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahpaspor/"?>" class="btn btn-mini btn-primary">Ubah data</a>
                        </div>
                                 <?php foreach ($tampil_data_paspor as $row) { ?>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                <td class="span3"> PASPORT 護照 :</td>
                                                <td> <?php echo $row->keterangan;?> </td>
                                            </tr>
                                            <tr>
                                                <td class="span2"> Berlaku sampai 到期 :</td>
                                                <td> <?php echo $row->berlaku;?> </td>
                                            </tr>
                                            <tr>
                                                <td class="span2"> Rencana 安排 :</td>

                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title"> Detail Medical <small>Detail Medical Pendaftar</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Admin</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Detail Medical</a><span class="divider-last">&nbsp;</span></li>
...
<div class="alert alert-info">
                        ...
                        <button data-dismiss="alert" class="close"> x </button> Silahkan menambahkan data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahmedical/"?>" class="btn btn-mini btn-primary">Tambah data medical</a>
                        </div>
                                 <?php
                                }else{ ?>
                                <div class="alert alert-info">
                        
                        <button data-dismiss="alert" class="close"> x </button> silahkan mengubah data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahmedical/"?>" class="btn btn-mini btn-primary">Ubah data</a>
                        </div>
                                 <?php foreach ($tampil_data_medical as $row) { ?>
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                <td class="span3"> 體檢 Pemeriksaan kesehatanl :</td>
                                                <td> <?php echo $row->keterangan;?> </td>
                                            </tr>
                                            <tr>
                                                <td class="span2"> 日期 Tanggal :</td>

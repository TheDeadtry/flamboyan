...
<div class="row-fluid">
 ...
 <div class="span8">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Tambah 家庭資料 / suhan DATA </h4><span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;" class="icon-remove"></a></span></div>
                                <div class="widget-body">

<form action="<?php echo site_url('tambahsuhan/tambahsuhandata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="hidden" />
                                    ...
                                    <a type="button" class="btn" href="<?php echo base_url()."index.php/detailsuhan/"?>"><i class=" icon-remove"></i> Kembali </a>
                                </div>

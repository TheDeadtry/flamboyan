                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title"> Detail Working Experience <small>Detail Working Experience Pendaftar</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Admin</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Detail Working Experience</a><span class="divider-last">&nbsp;</span></li>
...
<!--                                         <li><a href="javascript:void(0)"><i class="icon-user-md"></i> Interview Appraisal</a></li>
 -->
                                ...
                                <div class="span6">
                                    <h4><?php echo $row->nama;?> <br /><small><?php echo "".$detailworkingid ?></small></h4>
                                <?php }?>

<div class="alert alert-info">
                        
                        <button data-dismiss="alert" class="close"> x </button> silahkan menambahkan data pada tombol ini... <a href="<?php echo base_url()."index.php/tambahworking/"?>" class="btn btn-mini btn-primary">Tambah data working</a>
                        </div>
...
<div class="widget">
                                ...
                                <div class="widget-body">
									<div id="dvData"class="table-scrollable">
                                   <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url()."index.php/tambahworking/"?>" class="btn btn-mini btn-primary">Detail</a> </td>
